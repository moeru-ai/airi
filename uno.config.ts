...
export function sharedUnoConfig() {
  return defineConfig({
    ...
    theme: {
      fontFamily: {
        'sans': `"DM Sans Variant", "DM Sans", "Noto Sans CJK SC", "PingFang SC", "Microsoft YaHei", ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";`,
