...
const EnvSchema = object({
  ...
  // Steamworks app id used by the desktop ticket sign-in endpoint. Required
  // (no default); when missing the endpoint responds 503 STEAM_NOT_CONFIGURED.
  STEAM_APP_ID: optional(string()),
})
