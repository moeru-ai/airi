...
- 路由：[`server/apps/api/src/routes/admin/flux-grants/index.ts`](server/apps/api/src/routes/admin/flux-grants/index.ts)
- Service：[`server/apps/api/src/services/domain/admin/flux-grants/index.ts`](server/apps/api/src/services/domain/admin/flux-grants/index.ts)
- 单测：[`server/apps/api/src/services/domain/admin/flux-grants/tests/admin-flux-grants.test.ts`](server/apps/api/src/services/domain/admin/flux-grants/tests/admin-flux-grants.test.ts)
- adminGuard：[`server/apps/api/src/middlewares/admin-guard.ts`](server/apps/api/src/middlewares/admin-guard.ts)
