...
pnpm exec eslint server/apps/api/instrumentation.ts server/apps/api/src/routes/openai/v1/index.ts   # 0 warning/error
```
...
- `pnpm -F @proj-airi/server typecheck`:0 错误。
- `pnpm exec vitest run server/apps/api/src/services/domain/llm-tracing/index.test.ts server/apps/api/src/services/domain/llm-router/tests/router.test.ts server/apps/api/src/routes/openai/v1/route.test.ts`:3 files / 77 tests passed。
- `pnpm exec eslint server/apps/api/instrumentation.ts server/apps/api/src/routes/openai/v1/index.ts server/apps/api/src/services/domain/llm-tracing/index.ts server/apps/api/src/services/domain/llm-tracing/index.test.ts server/apps/api/src/services/domain/llm-router/router.ts server/apps/api/src/services/domain/llm-router/tests/router.test.ts packages/stage-ui/src/libs/providers/providers/official/shared.ts`:0 输出。
...
- `server/apps/api/src/services/domain/llm-router/tests/router.test.ts`:覆盖 `upstream.overrideModel` 同时写入 `ctx.upstreamModel`。
- `server/apps/api/src/routes/openai/v1/route.test.ts`:覆盖请求 `model=chat-auto`、router context 返回 `openai/gpt-4o-mini` 时,`startChatGeneration({ model })` 使用 `openai/gpt-4o-mini`。
- `pnpm exec vitest run server/apps/api/src/services/domain/llm-router/tests/router.test.ts server/apps/api/src/routes/openai/v1/route.test.ts server/apps/api/src/services/domain/llm-tracing/index.test.ts`:3 files / 78 tests passed。
- `pnpm -F @proj-airi/server typecheck`:0 错误。
- `pnpm exec eslint server/apps/api/src/routes/openai/v1/index.ts server/apps/api/src/routes/openai/v1/route.test.ts server/apps/api/src/services/domain/llm-router/router.ts server/apps/api/src/services/domain/llm-router/types.ts server/apps/api/src/services/domain/llm-router/tests/router.test.ts`:0 输出。
