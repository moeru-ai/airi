...
### `server/apps/api/instrumentation.ts`
...
### `server/apps/api/src/routes/openai/v1/index.ts`(`handleCompletion`)
...
### `server/apps/api/src/routes/openai/v1/index.ts`(`handleTTS`)
...
### `server/apps/api/src/libs/env.ts`
