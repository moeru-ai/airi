...
describe('remote user deletion service', () => {
  it('authenticates the Identity request and forwards the deletion contract', async () => {
    ...
    expect(url.toString()).toBe('https://api.airi.build/internal/identity/user-deletion')
