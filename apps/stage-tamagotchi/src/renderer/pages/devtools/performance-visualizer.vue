  ...
  <div :class="['flex flex-col gap-4', 'pb-6']">
    ...
    <div :class="['grid gap-3', 'md:grid-cols-2']">
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">Window lifecycle</div>
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">Three render</div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">VRM update frame</div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">Fade-on-hover hit test</div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4']">
        <div :class="['mb-2 text-sm text-neutral-400']">VRM lifecycle</div>
        <div :class="['grid gap-1 text-sm text-neutral-100']">
      ...
      <section :class="['rounded-2xl border border-neutral-700/60', 'bg-neutral-950/40 p-4', 'md:col-span-2']">
        <div :class="['mb-2 text-sm text-neutral-400']">Renderer / resource snapshots</div>
        <div :class="['grid gap-3 text-sm text-neutral-100', 'md:grid-cols-3']">
          <div>
            <div :class="['mb-1 text-xs text-neutral-400 uppercase tracking-wide']">after load</div>
          ...
          <div>
            <div :class="['mb-1 text-xs text-neutral-400 uppercase tracking-wide']">before dispose</div>
            ...
            <div>
              materialCount: {{ formatCount(resourceSnapshots.lastBeforeDispose?.sceneSummary?.materialCount) }}
            </div>
          </div>
          <div>
            <div :class="['mb-1 text-xs text-neutral-400 uppercase tracking-wide']">after dispose</div>
        ...
        <div :class="['mt-3 text-xs text-neutral-400']">history entries: {{ resourceSnapshots.history.length }}</div>
      </section>
    </div>
