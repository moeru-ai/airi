...
<template>
  <div :class="['relative', 'h-full', 'w-full', 'font-sans']">
    ...
    >
      <Skeleton animation="wave" :class="['col-span-3', 'h-[1lh]', 'w-20%', 'rounded-2xl']" />
      ...
      <div v-if="isLarge" :class="['relative', 'z-1', 'flex', 'h-full', 'flex-col', 'justify-between', 'gap-4']">
        ...
        <div :class="['grid', 'grid-cols-3', 'gap-3', 'text-white/80']">
          <div :class="['flex', 'flex-col', 'items-center', 'gap-1']">
            ...
            <div :class="['text-xs', 'text-white/60']">Wind</div>
          </div>
          <div :class="['flex', 'flex-col', 'items-center', 'gap-1']">
            ...
            <div :class="['text-xs', 'text-white/60']">Chance of rain</div>
          </div>
          <div :class="['flex', 'flex-col', 'items-center', 'gap-1']">
