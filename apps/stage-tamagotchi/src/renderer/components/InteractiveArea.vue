...
async function handleSend() {
  ...
  try {
    ...
    if (chatSession.activeSessionId === targetSessionId) {
      // A shared input cannot safely hold a draft from a session the user has
      // left while the cross-window request was pending.
