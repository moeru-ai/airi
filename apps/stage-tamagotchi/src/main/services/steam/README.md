...
Wraps [`steamworks-ffi-node`](https://github.com/ArtyProf/steamworks-ffi-node) for optional ticket sign-in when AIRI runs from the Steam client (App ID `3885340`).
