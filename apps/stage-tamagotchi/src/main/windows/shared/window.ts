...
import { createAppService, createScreenService, createVisionService, createWindowService } from '../../services/electron'
...
export async function setupBaseWindowElectronInvokes(params: {
  ...
  createVisionService({ context: params.context, window: params.window })
