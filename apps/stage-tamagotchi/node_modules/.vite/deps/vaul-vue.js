import { Bt as onUnmounted, E as withModifiers, G as createBaseVNode, Ht as openBlock, It as onMounted, J as createElementBlock, K as createBlock, Mt as onBeforeUnmount, Ot as mergeProps, Sn as withCtx, W as computed, Yt as renderSlot, _n as watch, cr as normalizeStyle, dt as getCurrentInstance, er as toRefs, fn as useSlots, kt as nextTick, qn as ref, rr as unref, rt as defineComponent, vn as watchEffect } from "./vue.runtime.esm-bundler-DOfC7S2N.js";
import "./dist-Bt6ADBo7.js";
import "./defu-tRXCiv2Z.js";
import { Ho as useForwardPropsEmits, Qo as createContext, So as DialogRoot_default, _o as DialogOverlay_default, go as DialogPortal_default, ho as DialogTitle_default, mo as DialogTrigger_default, vo as DialogDescription_default, xo as DialogClose_default, yo as DialogContent_default } from "./dist-DEhNMjJM.js";

//#region ../../node_modules/.pnpm/vaul-vue@0.4.1_reka-ui@2.8.2_vue@3.5.29_typescript@5.9.3___vue@3.5.29_typescript@5.9.3_/node_modules/vaul-vue/dist/index.js
(function() {
	"use strict";
	var t;
	try {
...
function bt() {
	...
	watchEffect((D) => {
		if (n.value && s.value) {
			...
			if (!$) return;
			ft(i.value && !t.value ? de(document.body, { background: "black" }) : Dt, de($, {
...
var Ct = /* @__PURE__ */ defineComponent({
	...
	setup(e) {
		const n = e, { onPress: s, onDrag: i, handleRef: t, handleOnly: w, isOpen: d, snapPoints: v, activeSnapPoint: D, isDragging: $, dismissible: T, closeDrawer: r } = ee(), l = ref(null), h = ref(!1);
		function m() {
			if (h.value) {
				H();
				return;
		...
		return (c, f) => (openBlock(), createElementBlock("div", {
			...
			onPointerdown: p,
			onPointermove: a
		}, [createBaseVNode("span", Ot, [renderSlot(c.$slots, "default")])], 40, $t));
	}
});

//#endregion
export { DialogClose_default as DrawerClose, Ct as DrawerContent, DialogDescription_default as DrawerDescription, Nt as DrawerHandle, Bt as DrawerOverlay, DialogPortal_default as DrawerPortal, St as DrawerRoot, _t as DrawerRootNested, DialogTitle_default as DrawerTitle, DialogTrigger_default as DrawerTrigger };
