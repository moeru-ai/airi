import { a as settings, g as MIPMAP_MODES, s as BLEND_MODES, u as CLEAR_MODES, x as SCALE_MODES } from "./ticker-_pHKYXuM.js";
import { a as DEG_TO_RAD, c as Point, g as rgb2hex, i as defaultVertex$1, n as Texture, p as hex2rgb, s as ObservablePoint, t as Filter } from "./core-DNmEIL6a.js";
import "./extensions-B3N6HnOQ.js";

//#region ../../node_modules/.pnpm/@pixi+filter-adjustment@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@_16196080849018b70f1fee220d821b6b/node_modules/@pixi/filter-adjustment/dist/filter-adjustment.esm.mjs
var extendStatics$33 = function(d, b) {
	extendStatics$33 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$33(d, b);
};
function __extends$33(d, b) {
	extendStatics$33(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
}
var vertex$30 = "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\n\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n    vTextureCoord = aTextureCoord;\n}";
var fragment$31 = "varying vec2 vTextureCoord;\nuniform sampler2D uSampler;\n\nuniform float gamma;\nuniform float contrast;\nuniform float saturation;\nuniform float brightness;\nuniform float red;\nuniform float green;\nuniform float blue;\nuniform float alpha;\n\nvoid main(void)\n{\n    vec4 c = texture2D(uSampler, vTextureCoord);\n\n    if (c.a > 0.0) {\n        c.rgb /= c.a;\n\n        vec3 rgb = pow(c.rgb, vec3(1. / gamma));\n        rgb = mix(vec3(.5), mix(vec3(dot(vec3(.2125, .7154, .0721), rgb)), rgb, saturation), contrast);\n        rgb.r *= red;\n        rgb.g *= green;\n        rgb.b *= blue;\n        c.rgb = rgb * brightness;\n\n        c.rgb *= c.a;\n    }\n\n    gl_FragColor = c * alpha;\n}\n";
/**
...
*/
var AdjustmentFilter = function(_super) {
	__extends$33(AdjustmentFilter, _super);
	/**
	...
	*/
	function AdjustmentFilter(options) {
		var _this = _super.call(this, vertex$30, fragment$31) || this;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-kawase-blur@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants_c0cf88ea895e9dd95da5cf12c6b8e260/node_modules/@pixi/filter-kawase-blur/dist/filter-kawase-blur.esm.mjs
var extendStatics$32 = function(d, b) {
	extendStatics$32 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$32(d, b);
};
function __extends$32(d, b) {
	extendStatics$32(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var KawaseBlurFilter = function(_super) {
	__extends$32(KawaseBlurFilter, _super);
	/**
	...
	*/
	function KawaseBlurFilter(blur, quality, clamp) {
		...
		var _this = _super.call(this, vertex$29, clamp ? fragmentClamp : fragment$30) || this;
		_this._kernels = [];
		_this._blur = 4;
		_this._quality = 3;
		...
		_this.pixelSize = 1;
		_this._clamp = clamp;
		if (Array.isArray(blur)) _this.kernels = blur;
		else {
			_this._blur = blur;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-advanced-bloom@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+consta_91484dd61ee730cff4d9af25827edf20/node_modules/@pixi/filter-advanced-bloom/dist/filter-advanced-bloom.esm.mjs
var extendStatics$31 = function(d, b) {
	extendStatics$31 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$31(d, b);
};
function __extends$31(d, b) {
	extendStatics$31(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var AdvancedBloomFilter = function(_super) {
	__extends$31(AdvancedBloomFilter, _super);
	/**
	...
	*/
	function AdvancedBloomFilter(options) {
		var _this = _super.call(this, vertex$28, fragment$1$1) || this;
	...
	*/
	...
	Object.defineProperty(AdvancedBloomFilter.prototype, "resolution", {
		...
		set: function(value) {
			...
			if (this._extractFilter) this._extractFilter.resolution = value;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-ascii@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5._ec8eab35c21d989f53fc4d5f405352db/node_modules/@pixi/filter-ascii/dist/filter-ascii.esm.mjs
var extendStatics$30 = function(d, b) {
	extendStatics$30 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$30(d, b);
};
function __extends$30(d, b) {
	extendStatics$30(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var AsciiFilter = function(_super) {
	__extends$30(AsciiFilter, _super);
	/**
	* @param {number} [size=8] - Size of the font
	*/
	function AsciiFilter(size) {
		if (size === void 0) size = 8;
		var _this = _super.call(this, vertex$27, fragment$28) || this;
		_this.size = size;
		return _this;
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-bevel@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5._30012092890182330f4507618768fca0/node_modules/@pixi/filter-bevel/dist/filter-bevel.esm.mjs
var extendStatics$29 = function(d, b) {
	extendStatics$29 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$29(d, b);
};
function __extends$29(d, b) {
	extendStatics$29(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var BevelFilter = function(_super) {
	__extends$29(BevelFilter, _super);
	/**
	...
	*/
	function BevelFilter(options) {
		var _this = _super.call(this, vertex$26, fragment$27) || this;
		_this._thickness = 2;
		_this._angle = 0;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-alpha@6.5.10_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5_34f75dcb4effbe7e796aae43a600200f/node_modules/@pixi/filter-alpha/dist/esm/filter-alpha.mjs
var extendStatics$28 = function(d, b) {
	extendStatics$28 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
	};
	return extendStatics$28(d, b);
};
function __extends$28(d, b) {
	extendStatics$28(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var AlphaFilter = function(_super) {
	__extends$28(AlphaFilter, _super);
	/**
	* @param alpha - Amount of alpha from 0 to 1, where 0 is transparent
	*/
	function AlphaFilter(alpha) {
		if (alpha === void 0) alpha = 1;
		var _this = _super.call(this, defaultVertex$1, fragment$26, { uAlpha: 1 }) || this;
		_this.alpha = alpha;
		return _this;
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-blur@6.5.10_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6.5.1_f9e26a0a963e942d3fab932543674425/node_modules/@pixi/filter-blur/dist/esm/filter-blur.mjs
var extendStatics$27 = function(d, b) {
	extendStatics$27 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
	};
	return extendStatics$27(d, b);
};
function __extends$27(d, b) {
	extendStatics$27(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var BlurFilterPass = function(_super) {
	__extends$27(BlurFilterPass, _super);
	/**
	...
	*/
	BlurFilterPass.prototype.apply = function(filterManager, input, output, clearMode) {
		if (output) if (this.horizontal) this.uniforms.strength = 1 / output.width * (output.width / input.width);
...
var BlurFilter = function(_super) {
	__extends$27(BlurFilter, _super);
	/**
	* @param strength - The strength of the blur filter.
	* @param quality - The quality of the blur filter.
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-bloom@4.2.0_84172d5a9c3f97ab2b843c48c30bfc44/node_modules/@pixi/filter-bloom/dist/filter-bloom.esm.mjs
var extendStatics$26 = function(d, b) {
	extendStatics$26 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$26(d, b);
};
function __extends$26(d, b) {
	extendStatics$26(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var BloomFilter = function(_super) {
	__extends$26(BloomFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-bulge-pinch@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants_e160d07abce2b7054eb37fcb26b11ede/node_modules/@pixi/filter-bulge-pinch/dist/filter-bulge-pinch.esm.mjs
var extendStatics$25 = function(d, b) {
	extendStatics$25 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$25(d, b);
};
function __extends$25(d, b) {
	extendStatics$25(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var BulgePinchFilter = function(_super) {
	__extends$25(BulgePinchFilter, _super);
	/**
	...
	*/
	function BulgePinchFilter(options) {
		var _this = _super.call(this, vertex$25, fragment$25) || this;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-color-map@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6_a67ff8698bf6093ec2e54d01c5af865b/node_modules/@pixi/filter-color-map/dist/filter-color-map.esm.mjs
var extendStatics$24 = function(d, b) {
	extendStatics$24 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$24(d, b);
};
function __extends$24(d, b) {
	extendStatics$24(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var ColorMapFilter = function(_super) {
	__extends$24(ColorMapFilter, _super);
	/**
	...
	*/
	function ColorMapFilter(colorMap, nearest, mix) {
		...
		if (mix === void 0) mix = 1;
		var _this = _super.call(this, vertex$24, fragment$24) || this;
	...
	*/
	...
	Object.defineProperty(ColorMapFilter.prototype, "colorMap", {
		...
		set: function(colorMap) {
			var _a;
			if (!colorMap) return;
			if (!(colorMap instanceof Texture)) colorMap = Texture.from(colorMap);
	...
	*/
	ColorMapFilter.prototype.destroy = function(destroyBase) {
		...
		if (this._colorMap) this._colorMap.destroy(destroyBase);
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-color-overlay@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensi_5baa5e6c30e91611282d9af33a5f9de9/node_modules/@pixi/filter-color-overlay/dist/filter-color-overlay.esm.mjs
var extendStatics$23 = function(d, b) {
	extendStatics$23 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$23(d, b);
};
function __extends$23(d, b) {
	extendStatics$23(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
*
*/
var ColorOverlayFilter = function(_super) {
	__extends$23(ColorOverlayFilter, _super);
	/**
	...
	*/
	function ColorOverlayFilter(color, alpha) {
		...
		if (alpha === void 0) alpha = 1;
		var _this = _super.call(this, vertex$23, fragment$23) || this;
		_this._color = 0;
		_this._alpha = 1;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-color-replace@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensi_28c8f29e9860e50e66f62f8899408b50/node_modules/@pixi/filter-color-replace/dist/filter-color-replace.esm.mjs
var extendStatics$22 = function(d, b) {
	extendStatics$22 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$22(d, b);
};
function __extends$22(d, b) {
	extendStatics$22(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
*
*/
var ColorReplaceFilter = function(_super) {
	__extends$22(ColorReplaceFilter, _super);
	/**
	...
	*/
	function ColorReplaceFilter(originalColor, newColor, epsilon) {
		if (originalColor === void 0) originalColor = 16711680;
		if (newColor === void 0) newColor = 0;
		if (epsilon === void 0) epsilon = .4;
		var _this = _super.call(this, vertex$22, fragment$22) || this;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-convolution@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extension_b2e2fad1b4c564931780237a003f74ed/node_modules/@pixi/filter-convolution/dist/filter-convolution.esm.mjs
var extendStatics$21 = function(d, b) {
	extendStatics$21 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$21(d, b);
};
function __extends$21(d, b) {
	extendStatics$21(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var ConvolutionFilter = function(_super) {
	__extends$21(ConvolutionFilter, _super);
	/**
	...
	*/
	function ConvolutionFilter(matrix, width, height) {
		...
		var _this = _super.call(this, vertex$21, fragment$21) || this;
		_this.uniforms.texelSize = new Float32Array(2);
		_this.uniforms.matrix = new Float32Array(9);
		if (matrix !== void 0) _this.matrix = matrix;
		_this.width = width;
		_this.height = height;
		return _this;
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-cross-hatch@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extension_ebd3e55518419dd3148441fe30f070cd/node_modules/@pixi/filter-cross-hatch/dist/filter-cross-hatch.esm.mjs
var extendStatics$20 = function(d, b) {
	extendStatics$20 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$20(d, b);
};
function __extends$20(d, b) {
	extendStatics$20(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var CrossHatchFilter = function(_super) {
	__extends$20(CrossHatchFilter, _super);
	function CrossHatchFilter() {
		return _super.call(this, vertex$20, fragment$20) || this;
	}
	return CrossHatchFilter;
}(Filter);

//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-crt@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6.5.10__0c52d279edb5c2dcff6782ca3571f821/node_modules/@pixi/filter-crt/dist/filter-crt.esm.mjs
var extendStatics$19 = function(d, b) {
	extendStatics$19 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$19(d, b);
};
function __extends$19(d, b) {
	extendStatics$19(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var CRTFilter = function(_super) {
	...
	*/
	function CRTFilter(options) {
		var _this = _super.call(this, vertex$19, fragment$19) || this;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-dot@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5.10_46406a952c194e0485ee2204bfd9f1e4/node_modules/@pixi/filter-dot/dist/filter-dot.esm.mjs
var extendStatics$18 = function(d, b) {
	extendStatics$18 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		d.__proto__ = b;
	} || function(d, b) {
		for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p];
	};
	return extendStatics$18(d, b);
};
function __extends$18(d, b) {
	extendStatics$18(d, b);
	function __() {
		this.constructor = d;
	}
	d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
...
var fragment$18 = "precision mediump float;\n\nvarying vec2 vTextureCoord;\nvarying vec4 vColor;\n\nuniform vec4 filterArea;\nuniform sampler2D uSampler;\n\nuniform float angle;\nuniform float scale;\n\nfloat pattern()\n{\n   float s = sin(angle), c = cos(angle);\n   vec2 tex = vTextureCoord * filterArea.xy;\n   vec2 point = vec2(\n       c * tex.x - s * tex.y,\n       s * tex.x + c * tex.y\n   ) * scale;\n   return (sin(point.x) * sin(point.y)) * 4.0;\n}\n\nvoid main()\n{\n   vec4 color = texture2D(uSampler, vTextureCoord);\n   float average = (color.r + color.g + color.b) / 3.0;\n   gl_FragColor = vec4(vec3(average * 10.0 - 5.0 + pattern()), color.a);\n}\n";
/**
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var DotFilter = function(_super) {
	__extends$18(DotFilter, _super);
	/**
	...
	*/
	function DotFilter(scale, angle) {
		...
		var _this = _super.call(this, vertex$18, fragment$18) || this;
		_this.scale = scale;
		_this.angle = angle;
		return _this;
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-drop-shadow@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants_4325a404897f877d73b65f2251b1ab12/node_modules/@pixi/filter-drop-shadow/dist/filter-drop-shadow.esm.mjs
...
var DropShadowFilter = function(_super) {
	__extends$17(DropShadowFilter, _super);
	/**
	...
	*/
	function DropShadowFilter(options) {
		...
		var kernels = opt.kernels, blur = opt.blur, quality = opt.quality, pixelSize = opt.pixelSize, resolution = opt.resolution;
		_this._tintFilter = new Filter(vertex$17, fragment$17);
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-emboss@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5_8458d3fe998fd9f70b4e7da43bcc67bc/node_modules/@pixi/filter-emboss/dist/filter-emboss.esm.mjs
...
var EmbossFilter = function(_super) {
	__extends$16(EmbossFilter, _super);
	/**
	* @param {number} [strength=5] - Strength of the emboss.
	*/
	function EmbossFilter(strength) {
		if (strength === void 0) strength = 5;
		var _this = _super.call(this, vertex$16, fragment$16) || this;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-glitch@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6.5._6c7e9043c2ba727216dd15e03615df05/node_modules/@pixi/filter-glitch/dist/filter-glitch.esm.mjs
...
var GlitchFilter = function(_super) {
	__extends$15(GlitchFilter, _super);
	/**
	...
	*/
	function GlitchFilter(options) {
		var _this = _super.call(this, vertex$15, fragment$15) || this;
	...
	*/
	GlitchFilter.prototype._randomizeSizes = function() {
		...
		var min = Math.min(this.minSize / size, .9 / this._slices);
		if (this.average) {
			var count = this._slices;
			var rest = 1;
			for (var i = 0; i < last; i++) {
				var averageWidth = rest / (count - i);
				var w = Math.max(averageWidth * (1 - Math.random() * .6), min);
				arr[i] = w;
				rest -= w;
			}
			arr[last] = rest;
	...
	*/
	GlitchFilter.prototype.shuffle = function() {
		var arr = this._sizes;
		for (var i = this._slices - 1; i > 0; i--) {
	...
	*/
	GlitchFilter.prototype._randomizeOffsets = function() {
		for (var i = 0; i < this._slices; i++) this._offsets[i] = Math.random() * (Math.random() < .5 ? -1 : 1);
	};
	/**
	...
	*/
	...
	Object.defineProperty(GlitchFilter.prototype, "sizes", {
		...
		set: function(sizes) {
			...
			for (var i = 0; i < len; i++) this._sizes[i] = sizes[i];
		},
		enumerable: false,
		configurable: true
	});
	Object.defineProperty(GlitchFilter.prototype, "offsets", {
		...
		set: function(offsets) {
			...
			for (var i = 0; i < len; i++) this._offsets[i] = offsets[i];
		},
		enumerable: false,
		configurable: true
	});
	...
	*/
	GlitchFilter.prototype.destroy = function() {
		var _a;
		(_a = this.texture) === null || _a === void 0 || _a.destroy(true);
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-glow@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5.1_bdcf237842ef399f1337cd67c766eb93/node_modules/@pixi/filter-glow/dist/filter-glow.esm.mjs
...
var GlowFilter = function(_super) {
	__extends$14(GlowFilter, _super);
	/**
	...
	*/
	function GlowFilter(options) {
		...
		_this = _super.call(this, vertex$14, fragment$14.replace(/__ANGLE_STEP_SIZE__/gi, "" + (1 / quality / distance).toFixed(7)).replace(/__DIST__/gi, distance.toFixed(0) + ".0")) || this;
		_this.uniforms.glowColor = new Float32Array([
			0,
			0,
			0,
			1
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-godray@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6.5._41842dbe687c085efd1e58fae48fa86d/node_modules/@pixi/filter-godray/dist/filter-godray.esm.mjs
...
*/
var GodrayFilter = function(_super) {
	__extends$13(GodrayFilter, _super);
	/**
	* @param {object} [options] - Filter options
	...
	*/
	function GodrayFilter(options) {
		var _this = _super.call(this, vertex$13, fragment$13.replace("${perlin}", perlin)) || this;
		/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-motion-blur@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants_10a85c2c094fb457c701374c4b1e02be/node_modules/@pixi/filter-motion-blur/dist/filter-motion-blur.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var MotionBlurFilter = function(_super) {
	__extends$12(MotionBlurFilter, _super);
	/**
	...
	*/
	function MotionBlurFilter(velocity, kernelSize, offset) {
		...
		var _this = _super.call(this, vertex$12, fragment$12) || this;
		/**
	...
	*/
	MotionBlurFilter.prototype.setVelocity = function(value) {
		...
		} else this._velocity.copyFrom(value);
	};
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-multi-color-replace@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+e_d7b26902ebfc07c3dd2469780035e54d/node_modules/@pixi/filter-multi-color-replace/dist/filter-multi-color-replace.esm.mjs
...
*
*/
var MultiColorReplaceFilter = function(_super) {
	__extends$11(MultiColorReplaceFilter, _super);
	/**
	...
	*/
	function MultiColorReplaceFilter(replacements, epsilon, maxColors) {
		if (epsilon === void 0) epsilon = .05;
		if (maxColors === void 0) maxColors = replacements.length;
		var _this = _super.call(this, vertex$11, fragment$11.replace(/%maxColors%/g, maxColors.toFixed(0))) || this;
		_this._replacements = [];
		_this._maxColors = 0;
		_this.epsilon = epsilon;
	...
	Object.defineProperty(MultiColorReplaceFilter.prototype, "replacements", {
		...
		set: function(replacements) {
			...
			for (var i = 0; i < colorCount; i++) {
				...
				var color = pair[0];
				if (typeof color === "number") color = hex2rgb(color);
				else pair[0] = rgb2hex(color);
				originals[i * 3] = color[0];
				originals[i * 3 + 1] = color[1];
				originals[i * 3 + 2] = color[2];
				var targetColor = pair[1];
				if (typeof targetColor === "number") targetColor = hex2rgb(targetColor);
				else pair[1] = rgb2hex(targetColor);
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-old-film@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6._9c9cc5ac43f5220a6b1dfdacf42203ff/node_modules/@pixi/filter-old-film/dist/filter-old-film.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var OldFilmFilter = function(_super) {
	__extends$10(OldFilmFilter, _super);
	/**
	...
	*/
	function OldFilmFilter(options, seed) {
		...
		var _this = _super.call(this, vertex$10, fragment$10) || this;
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-outline@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6.5_139a40dd1b3284208de0bf2ba78d695f/node_modules/@pixi/filter-outline/dist/filter-outline.esm.mjs
...
var OutlineFilter = function(_super) {
	__extends$9(OutlineFilter, _super);
	/**
	...
	*/
	function OutlineFilter(thickness, color, quality) {
		...
		var _this = _super.call(this, vertex$9, fragment$9.replace(/\$\{angleStep\}/, OutlineFilter.getAngleStep(quality))) || this;
		_this._thickness = 1;
		_this.uniforms.thickness = new Float32Array([0, 0]);
		_this.uniforms.outlineColor = new Float32Array([
			0,
			0,
			0,
			1
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-pixelate@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6_a89c966588beee5b7f0e8c0795a962d0/node_modules/@pixi/filter-pixelate/dist/filter-pixelate.esm.mjs
...
var PixelateFilter = function(_super) {
	__extends$8(PixelateFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-radial-blur@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extension_8d6e7a26767f9a5e686755810e216578/node_modules/@pixi/filter-radial-blur/dist/filter-radial-blur.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var RadialBlurFilter = function(_super) {
	__extends$7(RadialBlurFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-reflection@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@_ce4b3c96c74c4f3e64ad84b4eccc6e9a/node_modules/@pixi/filter-reflection/dist/filter-reflection.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var ReflectionFilter = function(_super) {
	__extends$6(ReflectionFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-rgb-split@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@_d3544fe7f6c4f94b910dbca89be3a680/node_modules/@pixi/filter-rgb-split/dist/filter-rgb-split.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var RGBSplitFilter = function(_super) {
	__extends$5(RGBSplitFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-shockwave@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@6_0efc0e6410262dd59b62dbb6167e7d5c/node_modules/@pixi/filter-shockwave/dist/filter-shockwave.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var ShockwaveFilter = function(_super) {
	__extends$4(ShockwaveFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-simple-lightmap@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+const_460668d77e0d5ca1c69e24ee2139afd2/node_modules/@pixi/filter-simple-lightmap/dist/filter-simple-lightmap.esm.mjs
...
*/
var SimpleLightmapFilter = function(_super) {
	__extends$3(SimpleLightmapFilter, _super);
	/**
	...
	*/
	function SimpleLightmapFilter(texture, color, alpha) {
		...
		_this._color = 0;
		_this.uniforms.dimensions = new Float32Array(2);
		_this.uniforms.ambientColor = new Float32Array([
			0,
			0,
			0,
			alpha
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-tilt-shift@4.2.0_@pixi+constants@6.5.10_@pixi+core@6.5.10_@pixi+constants@_06da17d7b4abd04911ebf70db226d5af/node_modules/@pixi/filter-tilt-shift/dist/filter-tilt-shift.esm.mjs
...
* @private
*/
var TiltShiftAxisFilter = function(_super) {
	__extends$2(TiltShiftAxisFilter, _super);
...
* @private
*/
var TiltShiftXFilter = function(_super) {
	__extends$2(TiltShiftXFilter, _super);
...
* @private
*/
var TiltShiftYFilter = function(_super) {
	__extends$2(TiltShiftYFilter, _super);
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var TiltShiftFilter = function(_super) {
	__extends$2(TiltShiftFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-twist@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@6.5._af4b1d0a245f062fc59b392f7355a910/node_modules/@pixi/filter-twist/dist/filter-twist.esm.mjs
...
* @see {@link https://www.npmjs.com/package/pixi-filters|pixi-filters}
*/
var TwistFilter = function(_super) {
	__extends$1(TwistFilter, _super);
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@pixi+filter-zoom-blur@4.2.0_@pixi+core@6.5.10_@pixi+constants@6.5.10_@pixi+extensions@_9e0c441fa3bd8c53a09e9a32cb7e1cc5/node_modules/@pixi/filter-zoom-blur/dist/filter-zoom-blur.esm.mjs
...
//#endregion
export { AdjustmentFilter, AdvancedBloomFilter, AsciiFilter, BevelFilter, BloomFilter, BulgePinchFilter, CRTFilter, ColorMapFilter, ColorOverlayFilter, ColorReplaceFilter, ConvolutionFilter, CrossHatchFilter, DotFilter, DropShadowFilter, EmbossFilter, GlitchFilter, GlowFilter, GodrayFilter, KawaseBlurFilter, MotionBlurFilter, MultiColorReplaceFilter, OldFilmFilter, OutlineFilter, PixelateFilter, RGBSplitFilter, RadialBlurFilter, ReflectionFilter, ShockwaveFilter, SimpleLightmapFilter, TiltShiftAxisFilter, TiltShiftFilter, TiltShiftXFilter, TiltShiftYFilter, TwistFilter, ZoomBlurFilter };
