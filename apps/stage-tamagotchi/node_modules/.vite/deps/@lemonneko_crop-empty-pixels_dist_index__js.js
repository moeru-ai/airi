//#region ../../node_modules/.pnpm/@lemonneko+crop-empty-pixels@0.1.1/node_modules/@lemonneko/crop-empty-pixels/dist/index.js
function cropImg(origin) {
	...
	let right = 0;
	let bottom = 0;
	for (let y = 0; y < toCrop.height; y++) for (let x = 0; x < toCrop.width; x++) {
	...
	croppedCanvas.getContext("2d").drawImage(toCrop, left, top, croppedWidth, croppedHeight, 0, 0, croppedWidth, croppedHeight);
	return croppedCanvas;
}

//#endregion
export { cropImg as default };
//# sourceMappingURL=@lemonneko_crop-empty-pixels_dist_index__js.js.map