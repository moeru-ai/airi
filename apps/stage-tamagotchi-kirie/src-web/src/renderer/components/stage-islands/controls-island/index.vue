...
const { isOutside: isOutsideByCursor } = useHostMouseInElement(islandElement)
...
function startDraggingWindow() {
  ...
  beginMove()
    .catch(error => console.error('[host-context] Failed to begin moving the host window.', error))
}
