...
import { useHostWindowResize } from '@proj-airi/stage-host-context'

const { handleResizeStart, isSupported } = useHostWindowResize()
</script>

<template>
  <div v-if="isSupported" class="resize-handles">
