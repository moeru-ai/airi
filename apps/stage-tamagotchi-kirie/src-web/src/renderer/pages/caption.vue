...
import { useHostEventaContext, useHostMouseAroundWindowBorder, useHostMouseInWindow } from '@proj-airi/stage-host-context'
...
const { isNearAnyBorder: isAroundWindowBorder } = useHostMouseAroundWindowBorder({ threshold: 30 })
