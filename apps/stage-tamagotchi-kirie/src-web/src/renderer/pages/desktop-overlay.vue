...
const getWindowBounds = useHostEventaInvoke(electron.window.getBounds)
const getReadiness = useHostEventaInvoke(getDesktopOverlayReadinessContract)
const applyAndRestartMcp = useHostEventaInvoke(electronMcpApplyAndRestart)
const callMcpTool = useHostEventaInvoke(electronMcpCallTool)
const getMcpRuntimeStatus = useHostEventaInvoke(electronMcpGetRuntimeStatus)
