...
const sendAction = useHostEventaInvoke(noticeWindowEventa.windowAction, context.value)
const notifyMounted = useHostEventaInvoke(noticeWindowEventa.pageMounted, context.value)
const notifyUnmounted = useHostEventaInvoke(noticeWindowEventa.pageUnmounted, context.value)
