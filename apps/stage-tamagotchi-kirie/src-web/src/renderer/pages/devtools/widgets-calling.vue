...
const openWidgets = useHostEventaInvoke(widgetsOpenWindow)
const prepareWindow = useHostEventaInvoke(widgetsPrepareWindow)
const addWidget = useHostEventaInvoke(widgetsAdd)
const updateWidget = useHostEventaInvoke(widgetsUpdate)
const removeWidget = useHostEventaInvoke(widgetsRemove)
const clearWidgets = useHostEventaInvoke(widgetsClear)
