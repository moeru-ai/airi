...
const getIsWindows = useHostEventaInvoke(electron.app.isWindows)
const setVibrancy = useHostEventaInvoke(electron.window.setVibrancy)
const setBackgroundMaterial = useHostEventaInvoke(electron.window.setBackgroundMaterial)
