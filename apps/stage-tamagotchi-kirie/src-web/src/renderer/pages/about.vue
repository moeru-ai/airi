...
const getUpdaterPreferences = useHostEventaInvoke(electronGetUpdaterPreferences)
const setUpdaterPreferences = useHostEventaInvoke(electronSetUpdaterPreferences)
