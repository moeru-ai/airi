...
import type { AuthMetrics, ObservabilityMetrics } from '../otel'

import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'

import { registerRollingActiveUsersGauge } from '../otel'
...
function makeDb(rows: unknown[], opts: { reject?: boolean } = {}) {
  ...
  return { db: { select } as unknown as AuthDatabase, select, from }
}
