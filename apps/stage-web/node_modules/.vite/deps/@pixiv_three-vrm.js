import { $r as MathUtils, Bs as Vector3, Ca as REVISION, Er as Line, F as AxesHelper, Fo as Skeleton, Gn as ImageLoader, I as BackSide, J as BufferAttribute, Lo as SkinnedMesh, Nr as LineSegments, Oo as ShaderMaterial, Or as LineBasicMaterial, Vi as Object3D, Xr as Material, Y as BufferGeometry, _a as Quaternion, ai as MeshBasicMaterial, cs as TangentSpaceNormalMap, ct as Color, hn as Euler, i as UniformsLib, ii as Mesh, ir as InterleavedBufferAttribute, kn as GLBufferAttribute, ks as UniformsUtils, ni as Matrix4, nn as DoubleSide, on as DynamicDrawUsage, rr as InterleavedBuffer, ti as Matrix3, zn as Group, zs as Vector2 } from "./three.module-Cub_nmrh.js";

//#region ../../node_modules/.pnpm/@pixiv+three-vrm@3.5.0_three@0.183.1/node_modules/@pixiv/three-vrm/lib/three-vrm.module.js
...
var _VRMExpressionMaterialColorBind = class _VRMExpressionMaterialColorBind2 {
	constructor({ material, type, targetValue, targetAlpha }) {
		...
		this._state = {
			color: this._initColorBindState(),
			alpha: this._initAlphaBindState()
		};
	}
	applyWeight(weight) {
...
function setTextureColorSpace(texture, colorSpace) {
	if (parseInt(REVISION, 10) >= 152) texture.colorSpace = colorSpace;
...
function getTextureColorSpace(texture) {
	if (parseInt(REVISION, 10) >= 152) return texture.colorSpace;
