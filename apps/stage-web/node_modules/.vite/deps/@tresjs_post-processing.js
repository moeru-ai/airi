import { Bt as onUnmounted, Qn as toRaw, St as inject, W as computed, Wt as provide, Xn as shallowRef, Yt as renderSlot, _n as watch, kt as nextTick, rt as defineComponent, vn as watchEffect } from "./vue.runtime.esm-bundler-DOfC7S2N.js";
import { $r as MathUtils, Bn as HalfFloatType, Bo as SphereGeometry, Bs as Vector3, Ds as Uniform, Eo as SRGBTransfer, Ht as DataTexture, Js as WebGLRenderTarget, Lt as CustomToneMapping, Oo as ShaderMaterial, Pr as LinearFilter, Qi as OrthographicCamera, Sn as FloatType, Ti as NeutralToneMapping, Vr as LinearToneMapping, Vs as Vector4, Xt as DepthTexture, Y as BufferGeometry, ai as MeshBasicMaterial, bi as NearestFilter, co as RawShaderMaterial, ct as Color, fo as RedFormat, ii as Mesh, it as CineonToneMapping, ki as NoBlending, ks as UniformsUtils, l as ACESFilmicToneMapping, m as AgXToneMapping, mo as ReinhardToneMapping, p as AdditiveBlending, ps as Timer, ui as MeshNormalMaterial, us as Texture, ut as ColorManagement, xn as Float32BufferAttribute, zs as Vector2 } from "./three.module-Cub_nmrh.js";
import { r as useDevicePixelRatio } from "./core-DDDqR7YV.js";
import { F as normalizeColor, G as useTres, K as useTresContext, U as useLoop } from "./tres-CFl1hQ_Q.js";
import "./dist-w_lTHz18.js";
import { $ as GodRaysEffect, A as DepthOfFieldEffect, D as DepthDownsamplingPass, F as DotScreenEffect, Gt as ScanlineEffect, Jt as SepiaEffect, K as FXAAEffect, Lt as SMAAEffect, M as DepthPickingPass, Nt as RenderPass$1, Q as GlitchMode, Qt as TextureEffect, St as NoiseEffect, Tt as OutlineEffect, U as EffectPass, V as EffectComposer$1, Xt as ShockWaveEffect, Z as GlitchEffect, _ as ColorAverageEffect, a as BlendFunction, f as BrightnessContrastEffect, kt as PixelationEffect, mt as LensDistortionEffect, n as ASCIITexture, nt as HueSaturationEffect, on as VignetteEffect, p as ChromaticAberrationEffect, rn as ToneMappingEffect, s as BloomEffect, t as ASCIIEffect, tn as TiltShiftEffect, tt as GridEffect, wt as NormalPass, y as ColorDepthEffect, z as Effect } from "./build-CQuHuhPl.js";

//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/capabilities/WebGL.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/shaders/CopyShader.js
/**
* @module CopyShader
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/Pass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/ShaderPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/MaskPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/EffectComposer.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/RenderPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/shaders/DigitalGlitch.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/GlitchPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/shaders/HalftoneShader.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/HalftonePass.js
/**
	...
	*/
	constructor(params) {
		...
		*/
		...
		for (const key in params) if (params.hasOwnProperty(key) && this.uniforms.hasOwnProperty(key)) this.uniforms[key].value = params[key];
		this._fsQuad = new FullScreenQuad(this.material);
	}
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/RenderPixelatedPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/shaders/OutputShader.js
/**
* @module OutputShader
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/OutputPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/shaders/SMAAShader.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/SMAAPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/shaders/LuminosityHighPassShader.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/three@0.183.1/node_modules/three/examples/jsm/postprocessing/UnrealBloomPass.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@tresjs+post-processing@3.4.0_@tresjs+core@5.5.0_three@0.183.1_vue@3.5.29_typescript@5._fd04c668b97cfd8d6e43755990897b56/node_modules/@tresjs/post-processing/dist/tres-post-processing.js
/**
...
*/
var effectComposerInjectionKey$1 = Symbol("effectComposerPmndrs");
var EffectComposerPmndrs_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const effectComposerParams = computed(() => {
			const plainEffectComposer = new EffectComposer$1();
			const params = {
		...
		const initEffectComposer = () => {
			...
			effectComposer.value = new EffectComposer$1(renderer.instance, effectComposerParams.value);
			effectComposer.value.addPass(new RenderPass$1(scene.value, camera.activeCamera.value));
...
var BloomPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "BloomPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var DepthOfFieldPmndrs_default = /* @__PURE__ */ defineComponent({
...
var GlitchPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "GlitchPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var NoisePmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "NoisePmndrs",
	props: {
		premultiply: {
			type: Boolean,
...
var OutlinePmndrs_default = /* @__PURE__ */ defineComponent({
...
var PixelationPmndrs_default = /* @__PURE__ */ defineComponent({
...
var VignettePmndrs_default = /* @__PURE__ */ defineComponent({
...
var BarrelBlurPmndrs_default = /* @__PURE__ */ defineComponent({
...
var ToneMappingPmndrs_default = /* @__PURE__ */ defineComponent({
...
var ChromaticAberrationPmndrs_default = /* @__PURE__ */ defineComponent({
...
var HueSaturationPmndrs_default = /* @__PURE__ */ defineComponent({
...
var ScanlinePmndrs_default = /* @__PURE__ */ defineComponent({
...
var KuwaharaPmndrs_default = /* @__PURE__ */ defineComponent({
...
var ColorAveragePmndrs_default = /* @__PURE__ */ defineComponent({
...
var LensDistortionPmndrs_default = /* @__PURE__ */ defineComponent({
...
var ShockWavePmndrs_default = /* @__PURE__ */ defineComponent({
...
var TiltShiftPmndrs_default = /* @__PURE__ */ defineComponent({
...
var DotScreenPmndrs_default = /* @__PURE__ */ defineComponent({
...
var SepiaPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "SepiaPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var LinocutPmndrs_default = /* @__PURE__ */ defineComponent({
...
var DepthPickingPassPmndrs_default = /* @__PURE__ */ defineComponent({
...
var GodRaysPmndrs_default = /* @__PURE__ */ defineComponent({
...
var ColorDepthPmndrs_default = /* @__PURE__ */ defineComponent({
...
var GridPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "GridPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var FishEyePmndrs_default = /* @__PURE__ */ defineComponent({
...
var BrightnessContrastPmndrs_default = /* @__PURE__ */ defineComponent({
...
var SMAAPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "SMAAPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var FXAAPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "FXAAPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var TexturePmndrs_default = /* @__PURE__ */ defineComponent({
...
var ASCIIPmndrs_default = /* @__PURE__ */ defineComponent({
	__name: "ASCIIPmndrs",
	props: {
		blendFunction: {
			type: null,
...
var effectComposerInjectionKey = Symbol("effectComposerThree");
var EffectComposer_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		if (!props.withoutRenderPass) watchEffect(() => {
			if (camera.activeCamera.value && scene.value && effectComposer.value) effectComposer.value.addPass(new RenderPass(scene.value, camera.activeCamera.value));
		});
		renderer.replaceRenderFunction((notifySuccess) => {
...
var Glitch_default = /* @__PURE__ */ defineComponent({
	__name: "Glitch",
	props: {
		dtSize: {
			type: Number,
...
var Pixelation_default = /* @__PURE__ */ defineComponent({
	__name: "Pixelation",
	props: {
		pixelSize: {
			type: Number,
...
var Output_default = /* @__PURE__ */ defineComponent({
	__name: "Output",
	setup(__props, { expose: __expose }) {
...
var SMAA_default = /* @__PURE__ */ defineComponent({
	__name: "SMAA",
	props: {
		width: {
			type: Number,
...
var UnrealBloom_default = /* @__PURE__ */ defineComponent({
	__name: "UnrealBloom",
	props: {
		radius: {
			type: Number,
