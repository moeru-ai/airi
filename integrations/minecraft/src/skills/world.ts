...
export function getNearestBlocks(mineflayer: Mineflayer, blockTypes: null | string | string[] = null, distance: number = DEFAULT_SCAN_RADIUS, count: number = 10000): Block[] {
