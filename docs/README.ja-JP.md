...
<p float="left" align="center">
  ...
  <a href="https://github.com/moeru-ai/airi/releases/download/v0.9.0-alpha.32/AIRI-0.9.0-alpha.32-windows-x64-setup.exe">
    <picture>
      <source
        width="33%"
  ...
  <a href="https://github.com/moeru-ai/airi/releases/download/v0.9.0-alpha.32/AIRI-0.9.0-alpha.32-darwin-arm64.dmg">
    <picture>
      <source
        width="33%"
