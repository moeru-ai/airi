...
<p float="left" align="center">
  ...
  <a href="https://static-cn-proj-airi.oss-cn-shanghai.aliyuncs.com/artifacts/apps/desktop/versions/v0.9.0-alpha.18/AIRI-0.9.0-alpha.18-windows-x64-setup.exe">
    <picture>
      <source
        width="33%"
  ...
  <a href="https://static-cn-proj-airi.oss-cn-shanghai.aliyuncs.com/artifacts/apps/desktop/versions/v0.9.0-alpha.18/AIRI-0.9.0-alpha.18-darwin-arm64.dmg">
    <picture>
      <source
        width="33%"
