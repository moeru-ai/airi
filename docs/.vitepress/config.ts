            ...
            items: [
              ...
              { text: 'Setup and Use', link: withBase('/en/docs/manual/tamagotchi/setup-and-use/') },
              {
                ...
                items: [
                  ...
                  { text: 'General Instructions', link: withBase('/en/docs/manual/config/common') },
                  {
                    text: 'Feature Configuration',
                    collapsed: true,
                    items: [
                      { text: 'Chat Model', link: withBase('/en/docs/manual/config/llm') },
                      { text: 'Voice Input and Output', link: withBase('/en/docs/manual/config/audio') },
                      { text: 'Vision Understanding', link: withBase('/en/docs/manual/config/vision') },
                  ...
                  },
                  {
                    ...
                    items: [
                      { text: 'Chat Providers', collapsed: true, items: [
                        ...
                        { text: 'Ollama (Local Model)', link: withBase('/en/docs/manual/config/providers/consciousness/ollama') },
                        { text: 'DeepSeek', link: withBase('/en/docs/manual/config/providers/consciousness/deepseek') },
                        { text: 'OpenAI and Compatible APIs', link: withBase('/en/docs/manual/config/providers/consciousness/openai') },
                        ...
                        { text: 'MiniMax (Mainland China)', link: withBase('/en/docs/manual/config/providers/consciousness/minimax') },
                        ...
                        { text: 'Novita AI', link: withBase('/en/docs/manual/config/providers/consciousness/novita') },
                        ...
                        { text: 'Zhipu AI', link: withBase('/en/docs/manual/config/providers/consciousness/zhipu') },
                        { text: 'Volcengine Coding Plan', link: withBase('/en/docs/manual/config/providers/consciousness/volcengine-coding-plan') },
                      ] },
                      { text: 'Speech Providers', collapsed: true, items: [
                        { text: 'AIRI Official Text-to-Speech (TTS)', link: withBase('/en/docs/manual/config/providers/speech/official') },
                        { text: 'Alibaba Cloud Model Studio (TTS)', link: withBase('/en/docs/manual/config/providers/speech/alibaba-cloud-model-studio') },
                        { text: 'Browser Local Text-to-Speech (TTS)', link: withBase('/en/docs/manual/config/providers/speech/browser-local') },
                        { text: 'CometAPI (TTS)', link: withBase('/en/docs/manual/config/providers/speech/comet-api') },
                        { text: 'Deepgram (TTS)', link: withBase('/en/docs/manual/config/providers/speech/deepgram') },
                        { text: 'Desktop Local Text-to-Speech (TTS)', link: withBase('/en/docs/manual/config/providers/speech/desktop-local') },
                        { text: 'ElevenLabs (TTS)', link: withBase('/en/docs/manual/config/providers/speech/elevenlabs') },
                        { text: 'Google Gemini (TTS)', link: withBase('/en/docs/manual/config/providers/speech/google-gemini') },
                        { text: 'Index-TTS (Local TTS)', link: withBase('/en/docs/manual/config/providers/speech/index-tts') },
                        { text: 'Kokoro (Local TTS)', link: withBase('/en/docs/manual/config/providers/speech/kokoro') },
                        { text: 'Microsoft Azure Speech (TTS)', link: withBase('/en/docs/manual/config/providers/speech/azure-speech') },
                        { text: 'MiniMax Speech (TTS)', link: withBase('/en/docs/manual/config/providers/speech/minimax') },
                        { text: 'Xiaomi MiMo (TTS)', link: withBase('/en/docs/manual/config/providers/speech/mimo') },
                        { text: 'OpenAI-compatible API (TTS)', link: withBase('/en/docs/manual/config/providers/speech/openai') },
                        { text: 'OpenRouter (TTS)', link: withBase('/en/docs/manual/config/providers/speech/openrouter') },
                        { text: 'Player2 Speech (TTS)', link: withBase('/en/docs/manual/config/providers/speech/player2') },
                        { text: 'Volcengine (TTS)', link: withBase('/en/docs/manual/config/providers/speech/volcengine') },
                      ] },
                      { text: 'Transcription Providers', collapsed: true, items: [
                        { text: 'AIRI Official Speech Recognition (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/official') },
                        { text: 'Alibaba Cloud NLS', link: withBase('/en/docs/manual/config/providers/transcription/aliyun') },
                        { text: 'Browser Local Speech Recognition (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/browser-local') },
                        { text: 'Browser Web Speech API (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/web-speech-api') },
                        { text: 'CometAPI (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/comet-api') },
                        { text: 'Desktop Local Speech Recognition (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/desktop-local') },
                        { text: 'Xiaomi MiMo (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/mimo') },
                        { text: 'OpenAI-compatible API (ASR/STT)', link: withBase('/en/docs/manual/config/providers/transcription/openai') },
                      ] },
                      { text: 'Artistry Providers', collapsed: true, items: [
                        { text: 'ComfyUI (Artistry)', link: withBase('/en/docs/manual/config/providers/artistry/comfyui') },
                        { text: 'Nano Banana (Artistry)', link: withBase('/en/docs/manual/config/providers/artistry/nanobanana') },
                        { text: 'Replicate (Artistry)', link: withBase('/en/docs/manual/config/providers/artistry/replicate') },
                      ] },
                    ],
                  },
                ],
