                ...
                items: [
                  ...
                  { text: 'Service Providers', collapsed: true, items: [
                    { text: 'Chat Providers', collapsed: true, items: [
                      ...
                      { text: 'CometAPI', link: withBase('/en/docs/manual/config/providers/consciousness/comet-api') },
                      ...
                      { text: 'Moonshot', link: withBase('/en/docs/manual/config/providers/consciousness/moonshot') },
                    ...
                    { text: 'Speech Synthesis (TTS)', collapsed: true, items: [
                      { text: 'AIRI Official Speech Synthesis', link: withBase('/en/docs/manual/config/providers/speech/official') },
                      ...
                      { text: 'CometAPI', link: withBase('/en/docs/manual/config/providers/speech/comet-api') },
                      ...
                      { text: 'Index-TTS', link: withBase('/en/docs/manual/config/providers/speech/index-tts') },
                      { text: 'Kokoro', link: withBase('/en/docs/manual/config/providers/speech/kokoro') },
                      { text: 'Microsoft Azure Speech', link: withBase('/en/docs/manual/config/providers/speech/azure-speech') },
                      { text: 'MiniMax Speech', link: withBase('/en/docs/manual/config/providers/speech/minimax') },
                      ...
                      { text: 'Player2 Speech', link: withBase('/en/docs/manual/config/providers/speech/player2') },
                      { text: 'Volcengine', link: withBase('/en/docs/manual/config/providers/speech/volcengine') },
                    ] },
                    { text: 'Speech Recognition (ASR/STT)', collapsed: true, items: [
                      { text: 'AIRI Official Speech Recognition', link: withBase('/en/docs/manual/config/providers/transcription/official') },
                      { text: 'Alibaba Cloud Speech', link: withBase('/en/docs/manual/config/providers/transcription/aliyun') },
                      ...
                      { text: 'CometAPI', link: withBase('/en/docs/manual/config/providers/transcription/comet-api') },
                    ...
                    { text: 'Art Creation Providers', collapsed: true, items: [
                ...
                items: [
                  ...
                  { text: 'サービスプロバイダー', collapsed: true, items: [
                    { text: 'チャットプロバイダー', collapsed: true, items: [
                      ...
                      { text: 'AIHubMix', link: withBase('/ja/docs/manual/config/providers/consciousness/aihubmix') },
                      { text: 'Amazon Bedrock', link: withBase('/ja/docs/manual/config/providers/consciousness/amazon-bedrock') },
                      { text: 'Anthropic', link: withBase('/ja/docs/manual/config/providers/consciousness/anthropic') },
                      { text: 'Atlas Cloud', link: withBase('/ja/docs/manual/config/providers/consciousness/atlascloud') },
                      { text: 'Azure AI Foundry', link: withBase('/ja/docs/manual/config/providers/consciousness/azure-ai-foundry') },
                      { text: 'Azure OpenAI', link: withBase('/ja/docs/manual/config/providers/consciousness/azure-openai') },
                      { text: 'BytePlus', link: withBase('/ja/docs/manual/config/providers/consciousness/byteplus') },
                      { text: 'BytePlus Coding Plan', link: withBase('/ja/docs/manual/config/providers/consciousness/byteplus-coding-plan') },
                      { text: 'Cerebras', link: withBase('/ja/docs/manual/config/providers/consciousness/cerebras') },
                      { text: 'CometAPI', link: withBase('/ja/docs/manual/config/providers/consciousness/comet-api') },
                      { text: 'Google Gemini', link: withBase('/ja/docs/manual/config/providers/consciousness/google-gemini') },
                      { text: 'xAI', link: withBase('/ja/docs/manual/config/providers/consciousness/xai') },
                      { text: 'Cloudflare Workers AI', link: withBase('/ja/docs/manual/config/providers/consciousness/cloudflare-workers-ai') },
                      { text: 'LM Studio（ローカルモデル）', link: withBase('/ja/docs/manual/config/providers/consciousness/lm-studio') },
                      { text: 'OpenPaths', link: withBase('/ja/docs/manual/config/providers/consciousness/openpaths') },
                      { text: 'OpenRouter', link: withBase('/ja/docs/manual/config/providers/consciousness/openrouter') },
                      { text: 'Ollama', link: withBase('/ja/docs/manual/config/providers/consciousness/ollama') },
                      { text: 'DeepSeek', link: withBase('/ja/docs/manual/config/providers/consciousness/deepseek') },
                      { text: 'OpenAI と互換 API', link: withBase('/ja/docs/manual/config/providers/consciousness/openai') },
                      { text: '302.ai', link: withBase('/ja/docs/manual/config/providers/consciousness/302ai') },
                      { text: 'Fireworks AI', link: withBase('/ja/docs/manual/config/providers/consciousness/fireworks') },
                      { text: 'Featherless.ai', link: withBase('/ja/docs/manual/config/providers/consciousness/featherless') },
                      { text: 'Groq', link: withBase('/ja/docs/manual/config/providers/consciousness/groq') },
                      { text: 'MiniMax', link: withBase('/ja/docs/manual/config/providers/consciousness/minimax') },
                      { text: 'MiniMax Global', link: withBase('/ja/docs/manual/config/providers/consciousness/minimax-global') },
                      { text: 'Mistral', link: withBase('/ja/docs/manual/config/providers/consciousness/mistral') },
                      { text: 'Xiaomi MiMo', link: withBase('/ja/docs/manual/config/providers/consciousness/mimo') },
                      { text: 'ModelScope', link: withBase('/ja/docs/manual/config/providers/consciousness/modelscope') },
                      { text: 'Moonshot', link: withBase('/ja/docs/manual/config/providers/consciousness/moonshot') },
                      { text: 'NVIDIA NIM', link: withBase('/ja/docs/manual/config/providers/consciousness/nvidia') },
                      { text: 'n1n', link: withBase('/ja/docs/manual/config/providers/consciousness/n1n') },
                      { text: 'Novita', link: withBase('/ja/docs/manual/config/providers/consciousness/novita') },
                      { text: 'Perplexity', link: withBase('/ja/docs/manual/config/providers/consciousness/perplexity') },
                      { text: 'Together.ai', link: withBase('/ja/docs/manual/config/providers/consciousness/together') },
                      { text: 'Z.ai', link: withBase('/ja/docs/manual/config/providers/consciousness/zhipu') },
                      { text: 'Volcengine Coding Plan', link: withBase('/ja/docs/manual/config/providers/consciousness/volcengine-coding-plan') },
                    ] },
                    { text: '音声合成（TTS）', collapsed: true, items: [
                      { text: 'AIRI 公式音声合成', link: withBase('/ja/docs/manual/config/providers/speech/official') },
                      { text: 'Alibaba Cloud Model Studio', link: withBase('/ja/docs/manual/config/providers/speech/alibaba-cloud-model-studio') },
                      { text: 'ブラウザー（ローカル）', link: withBase('/ja/docs/manual/config/providers/speech/browser-local') },
                      { text: 'CometAPI', link: withBase('/ja/docs/manual/config/providers/speech/comet-api') },
                      { text: 'Deepgram', link: withBase('/ja/docs/manual/config/providers/speech/deepgram') },
                      { text: 'デスクトップ（ローカル）', link: withBase('/ja/docs/manual/config/providers/speech/desktop-local') },
                      { text: 'ElevenLabs', link: withBase('/ja/docs/manual/config/providers/speech/elevenlabs') },
                      { text: 'Google Gemini', link: withBase('/ja/docs/manual/config/providers/speech/google-gemini') },
                      { text: 'Index-TTS', link: withBase('/ja/docs/manual/config/providers/speech/index-tts') },
                      { text: 'Kokoro', link: withBase('/ja/docs/manual/config/providers/speech/kokoro') },
                      { text: 'Microsoft Azure Speech', link: withBase('/ja/docs/manual/config/providers/speech/azure-speech') },
                      { text: 'MiniMax Speech', link: withBase('/ja/docs/manual/config/providers/speech/minimax') },
                      { text: 'Xiaomi MiMo', link: withBase('/ja/docs/manual/config/providers/speech/mimo') },
                      { text: 'OpenAI と互換 API', link: withBase('/ja/docs/manual/config/providers/speech/openai') },
                      { text: 'OpenRouter', link: withBase('/ja/docs/manual/config/providers/speech/openrouter') },
                      { text: 'Player2 Speech', link: withBase('/ja/docs/manual/config/providers/speech/player2') },
                      { text: 'Volcengine', link: withBase('/ja/docs/manual/config/providers/speech/volcengine') },
                    ] },
                    { text: '音声認識（ASR/STT）', collapsed: true, items: [
                      { text: 'AIRI 公式音声認識', link: withBase('/ja/docs/manual/config/providers/transcription/official') },
                      { text: 'Alibaba Cloud Speech', link: withBase('/ja/docs/manual/config/providers/transcription/aliyun') },
                      { text: 'ブラウザー（ローカル）', link: withBase('/ja/docs/manual/config/providers/transcription/browser-local') },
                      { text: 'ブラウザー Web Speech API', link: withBase('/ja/docs/manual/config/providers/transcription/web-speech-api') },
                      { text: 'CometAPI', link: withBase('/ja/docs/manual/config/providers/transcription/comet-api') },
                      { text: 'デスクトップ（ローカル）', link: withBase('/ja/docs/manual/config/providers/transcription/desktop-local') },
                      { text: 'Xiaomi MiMo', link: withBase('/ja/docs/manual/config/providers/transcription/mimo') },
                      { text: 'OpenAI と互換 API', link: withBase('/ja/docs/manual/config/providers/transcription/openai') },
                    ] },
                    { text: 'アート生成プロバイダー', collapsed: true, items: [
                      { text: 'ComfyUI（ローカルワークフロー）', link: withBase('/ja/docs/manual/config/providers/artistry/comfyui') },
                      { text: 'Nano Banana', link: withBase('/ja/docs/manual/config/providers/artistry/nanobanana') },
                      { text: 'Replicate', link: withBase('/ja/docs/manual/config/providers/artistry/replicate') },
                    ] },
                  ] },
                ],
              },
