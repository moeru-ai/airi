        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: 'Setup and Use',
                link: withBase('/en/docs/manual/tamagotchi/setup-and-use/'),
              },
              {
                text: 'Configuration',
                items: [
                  ...
                  { text: 'Providers', collapsed: true, items: [
                    ...
                    { text: 'Text-to-Speech (TTS)', collapsed: true, items: [
                      { text: 'AIRI Official Text-to-Speech', link: withBase('/en/docs/manual/config/providers/speech/official') },
                      { text: 'Alibaba Cloud Model Studio', link: withBase('/en/docs/manual/config/providers/speech/alibaba-cloud-model-studio') },
                      { text: 'Browser Local Text-to-Speech', link: withBase('/en/docs/manual/config/providers/speech/browser-local') },
                      ...
                      { text: 'Desktop Local Text-to-Speech', link: withBase('/en/docs/manual/config/providers/speech/desktop-local') },
                      ...
                      { text: 'OpenAI-compatible API', link: withBase('/en/docs/manual/config/providers/speech/openai') },
                    ...
                    { text: 'Speech Recognition (ASR/STT)', collapsed: true, items: [
                      ...
                      { text: 'Browser Local Speech Recognition', link: withBase('/en/docs/manual/config/providers/transcription/browser-local') },
                      { text: 'Web Speech API', link: withBase('/en/docs/manual/config/providers/transcription/web-speech-api') },
                      { text: 'CometAPI', link: withBase('/en/docs/manual/config/providers/transcription/comet-api') },
                      { text: 'Desktop Local Speech Recognition', link: withBase('/en/docs/manual/config/providers/transcription/desktop-local') },
                      { text: 'Xiaomi MiMo', link: withBase('/en/docs/manual/config/providers/transcription/mimo') },
                      { text: 'OpenAI-compatible API', link: withBase('/en/docs/manual/config/providers/transcription/openai') },
                    ] },
                    { text: 'Artistry Providers', collapsed: true, items: [
                      { text: 'ComfyUI (Local Workflows)', link: withBase('/en/docs/manual/config/providers/artistry/comfyui') },
            ...
            items: [
              {
                text: 'Contributing',
                items: [
                  { text: 'Development Environment & First Contribution', link: withBase('/en/docs/contributing/') },
