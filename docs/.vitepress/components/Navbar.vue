...
<template>
  ...
  <nav class="items-center hidden lg:flex">
    ...
    <a
      ...
      target="_blank"
      class="text-muted-foreground hover:bg-muted hover:text-foreground h-9 w-9 flex flex-shrink-0 items-center justify-center rounded-lg bg-transparent text-xl"
      transition="colors duration-200 ease-in-out"
    >
          ...
          <nav class="flex flex-col">
            ...
            <div class="flex items-center gap-2 px-2">
              <DropdownMenuItem
                ...
                :aria-label="link.icon"
                target="_blank"
                class="text-muted-foreground hover:bg-muted hover:text-foreground h-9 w-9 flex items-center justify-center rounded-lg bg-transparent text-xl"
                transition="colors duration-200 ease-in-out"
              >
                <Icon :icon="`simple-icons:${link.icon}`" />
              </DropdownMenuItem>
