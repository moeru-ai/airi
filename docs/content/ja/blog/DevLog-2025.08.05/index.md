...
<ThemedVideo autoplay src="./assets/airi-demo-settings-hearing.mp4" />
...
<img class="light" src="./assets/airi-demo-onboarding-light.avif" alt="オンボーディング ライトモード" />
<img class="dark" src="./assets/airi-demo-onboarding-dark.avif" alt="オンボーディング ダークモード" />
...
<img class="light" src="./assets/airi-demo-vrm-light.avif" alt="時系列チャート ライトモード" />
<img class="dark" src="./assets/airi-demo-vrm-dark.avif" alt="時系列チャート ダークモード" />
...
<ThemedVideo
  autoplay
  light="./assets/airi-demo-quick-editor-mobile-light.mp4"
  dark="./assets/airi-demo-quick-editor-mobile-dark.mp4"
/>
...
<img class="light" src="./assets/airi-ui-level-meter-light.avif" alt="レベルメーター ライトモード" />
<img class="dark" src="./assets/airi-ui-level-meter-dark.avif" alt="レベルメーター ダークモード" />
...
<img class="light" src="./assets/airi-ui-time-series-chart-light.avif" alt="時系列チャート ライトモード" />
<img class="dark" src="./assets/airi-ui-time-series-chart-dark.avif" alt="時系列チャート ダークモード" />
...
<img class="light" src="./assets/airi-docs-blogs-light.avif" alt="ブログ ライトモード" />
<img class="dark" src="./assets/airi-docs-blogs-dark.avif" alt="ブログ ダークモード" />
...
<img class="light" src="./assets/airi-packages-i18n-light.avif" alt="i18n パッケージ ライトモード" />
<img class="dark" src="./assets/airi-packages-i18n-dark.avif" alt="i18n パッケージ ダークモード" />
...
<div class="w-full flex flex-col items-center justify-center gap-3 py-3">
  <img src="./assets/relu-sticker-thinks.avif" alt="ReLU 思考中ステッカー" class="w-30!" />
