...
- 「開発者」 - 開発およびトラブルシューティングのための高度なツール。日常使用には設定は必要ありません。詳細については、[開発者ガイド](../../../contributing/desktop-developer-tools) を参照してください。
...
1. Discord アプリケーションを作成し、必要なインテントを有効にし、[Discord ボット統合ガイド](../../../integrations/discord.md) でボット トークンを設定します。
...
[X / Twitter 統合ガイド](../../../integrations/x.md) を読んで、X 開発者プラットフォーム アプリケーションの資格情報を作成して入力してください。 API キー、API シークレット、またはアクセス トークンを公開しないでください。
...
Minecraft を統合するには、ソースからローカル エージェント サービスを実行する必要があります。 [Minecraft エージェント統合ガイド](../../../integrations/minecraft.md) に従って、信頼できるサーバー、AIRI、およびモデル サービスを構成し、エージェントを起動してください。
...
[Factor Integration Guide](../../../integrations/factorio.md) を読み、信頼できるサーバーのアドレス、ポート、ゲーム内ユーザー名を AIRI に入力してください。 AIRI には、すぐに展開できる Factorio サーバー側統合が付属していません。
...
このページは、実験的な機能の開発、トラブルシューティング、検証に使用されます。一般ユーザーが操作する必要はありません。ツールの詳細な説明は、[開発者ガイド → 開発者ツール](../../../contributing/desktop-developer-tools) に移動されました。
