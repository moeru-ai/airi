...
1. [Cloudflare API トークン](https://dash.cloudflare.com/profile/api-tokens)，创建具有 Workers AI アクセス用の API トークン) を開きます。
2. トークンをコピーします。
3. [Cloudflareコンソール](https://dash.cloudflare.com/)中找到并复制アカウントID.
