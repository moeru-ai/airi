...
[Last time](../DevLog-2025.04.06/#memory-system-memory-system) we discussed Moeka's memory system. Today, let's dive deeper into how to implement such a complex memory system and explore future prospects.
...
To build a good memory layer for Moeka, we need to establish a good reranking mechanism, combining RAG basic capabilities with past search engine reranking experience.

## Memory Layer Experimental Platform

[Project Moeka Memory Driver @duckdb/duckdb-wasm Playground](https://drizzle-orm-duckdb-wasm.netlify.app/#/memory-decay)
...
## How Should Moeka Be Designed?

From this, we can glimpse Moeka's implementation principles:
