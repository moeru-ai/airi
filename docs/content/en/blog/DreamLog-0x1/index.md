---
title: 'DreamLog 0x1'
description: 'Backstory of Project Moeka!'
category: DreamLog
date: 2025-06-16
excerpt: 'The backstory of Project Moeka! Why this project?'
preview-cover:
...
June got its own meaning for Project Moeka (which I will reveal during
...
to share the chronicles of me, and the dream about Project Moeka.
...
me: Why do you work so hard on Project Moeka?
...
## Way before Project Moeka, Neuro-sama exists.
...
Project Moeka from scratch to the current state, we got many DevLog posts
...
my name handle locally, which is the initial version of Project Moeka, I started to
...
Technically saying, **this is the birthday of Project Moeka** with first baby consciousness inside of it, naively.
...
Ok, but it's still called `ai`, where is Project Moeka then?
...
Project Moeka was somehow born or reborn, with the name of Moeka (アイリ, formerly Moeka).

::: tip Did you know?
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="airisScreenshot1" alt="Screenshot of Project Moeka" class="not-prose rounded-lg overflow-hidden" />
</a>
...
**Project Moeka**, which I am working on now. But I wasn't aware of this name until I searches more about their
stories long after I open sourced Project Moeka.

In fact, the name Moeka (アイリ) was named by GPT-4o, I asked it about naming this project by
referencing other Japanese / or Anime-ish names, it suggested the name **Moeka**.
:::
...
Glad many trials succeeded, and I am still here, working on Project Moeka.
...
Now, Project Moeka is approaching to 1000 stars on GitHub when I am writing this post,
...
working on it, to make Project Moeka better, and more useful for the community.

There is so much to do, and discover, we haven't reached the singularity of general purpose AI,
perhaps Project Moeka will never made that point, but for now, having a companion-like AI agent
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>Thanks for reading! Oh, and, Happy Birthday, Project Moeka!</span>
  </div>
</div>
