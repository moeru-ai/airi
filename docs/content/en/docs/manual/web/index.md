...
When AIRI opens for the first time, select **Setup with your provider**, or select **Sign in** to use the official AIRI provider.
...
Select a compatible chat model, then select **Let's do it!**.
