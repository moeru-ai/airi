...
Browser (Local) speech recognition is not available yet. Its Moeka settings page currently shows a Work in Progress placeholder, so models cannot be prepared or enabled.
