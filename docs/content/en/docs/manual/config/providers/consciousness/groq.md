---
title: Groq
description: Configuring Groq as a large model service provider in AIRI
...
Do not submit the API Key to the repository, include screenshots, or send it to others. Once a key is compromised, immediately revoke it and create a new key in the Groq console.
:::
