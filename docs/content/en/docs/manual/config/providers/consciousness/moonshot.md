---
title: Moonshot AI
description: Configure Moonshot AI as a chat provider in Moeka
is_openai_compatible: true
---

Moonshot AI provides a chat API compatible with the OpenAI format. After completing the configuration on this page, Moeka can use Moonshot AI models in Consciousness.

::: info Why choose Moonshot?
If you want to use the Moonshot model in Moeka, or already have a Moonshot API Key, you can choose this service provider directly.
:::
...
If the API check fails, verify the API key, available credit or quota, rate limits, and network connection. If Moeka cannot load the model list, enter the exact model ID provided by Moonshot manually on the **Consciousness** page.
