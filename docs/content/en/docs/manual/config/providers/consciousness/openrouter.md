---
title: OpenRouter
description: Configure OpenRouter as a chat provider in Moeka
is_openai_compatible: true
---

OpenRouter is an aggregation API service provider. After completing the configuration on this page, Moeka can use the chat model provided by OpenRouter in Consciousness.
...
If the API check fails, verify the API key, available credit or quota, rate limits, and network connection. If Moeka cannot load the model list, enter the exact model ID provided by OpenRouter manually on the **Consciousness** page.
