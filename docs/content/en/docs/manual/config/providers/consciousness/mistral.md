---
title: Mistral
description: Configure Mistral as a chat provider in Moeka
is_openai_compatible: true
---

Mistral provides a chat API compatible with the OpenAI format. After completing the configuration on this page, Moeka can use the models provided by Mistral in Consciousness.

::: info Why choose Mistral?
If you already use Mistral models, or want to try their multilingual models in Moeka, you can choose this provider.
:::
...
If the API check fails, verify the API key, available credit or quota, rate limits, and network connection. If Moeka cannot load the model list, enter the exact model ID provided by Mistral manually on the **Consciousness** page.
