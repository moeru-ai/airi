...
description: Configuring native Kokoro speech synthesis in Moeka
---

Kokoro runs speech synthesis as a native model in Moeka.
...
1. Open Moeka and wait for the model download to complete on first use.
2. WebGPU accelerates synthesis when available. Moeka can fall back to WASM without WebGPU, but synthesis will generally be slower and use more CPU.
...
2. Select an available Kokoro model provided by Moeka.
...
2. Enter a short test sentence and confirm that Moeka plays the generated audio.
