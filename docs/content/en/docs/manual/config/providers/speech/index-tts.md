...
1. Open **Settings → Providers → Speech → Index-TTS by Bilibili**.
...
Open **Settings → Modules → Speech**, select **Index-TTS**, choose model ID `IndexTTS-1.5`, and select a voice. The provider test alone does not enable speech for normal replies.
