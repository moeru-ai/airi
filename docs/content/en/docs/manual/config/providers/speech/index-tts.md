...
description: Connecting to the local Index-TTS service in Moeka
---

Index-TTS connects to Moeka through a local HTTP service.
...
2. Moeka connects to `http://localhost:11996/tts/` by default; if you use other hosts or ports, please record the complete address.
...
1. Select an available voice in the provider playground. This page uses the configured Index-TTS service and Moeka's default model ID.
