...
<template>
  <ConfigProvider :dir="dir">
    <div class="mx-auto max-w-[1400px] flex flex-col items-center justify-center gap-y-[8rem] p-10">
      <div class="text-2xl">
        👋 {{ $t("hello") }}
      </div>
      <div class="text-2xl">
      ...
      >
        <SelectTrigger
          class="text-grass11 hover:bg-mauve3 h-[35px] min-w-[160px] inline-flex items-center justify-between gap-[5px] rounded bg-white px-[15px] text-[13px] leading-none shadow-[0_2px_10px] shadow-black/10 outline-none data-[placeholder]:text-green9 focus:shadow-[0_0_0_2px] focus:shadow-black"
            ...
            <SelectViewport class="p-[5px]">
              ...
              <SelectGroup>
                <SelectItem
                  ...
                  :key="index"
                  class="text-grass11 data-[disabled]:text-mauve8 relative h-[25px] flex select-none items-center rounded-[3px] pl-[25px] pr-[35px] text-[13px] leading-none data-[disabled]:pointer-events-none data-[highlighted]:bg-green9 data-[highlighted]:text-green1 data-[highlighted]:outline-none"
                  :value="option.value"
                >
