...
<img class="light" src="./assets/airi-demo-onboarding-light.avif" alt="온보딩 라이트 모드" />
<img class="dark" src="./assets/airi-demo-onboarding-dark.avif" alt="온보딩 다크 모드" />
...
<img class="light" src="./assets/airi-demo-vrm-light.avif" alt="VRM 라이트 모드" />
<img class="dark" src="./assets/airi-demo-vrm-dark.avif" alt="VRM 다크 모드" />
...
<img class="light" src="./assets/airi-ui-level-meter-light.avif" alt="레벨 미터 라이트 모드" />
<img class="dark" src="./assets/airi-ui-level-meter-dark.avif" alt="레벨 미터 다크 모드" />
...
<img class="light" src="./assets/airi-ui-time-series-chart-light.avif" alt="시계열 차트 라이트 모드" />
<img class="dark" src="./assets/airi-ui-time-series-chart-dark.avif" alt="시계열 차트 다크 모드" />
...
<img class="light" src="./assets/airi-docs-blogs-light.avif" alt="문서 블로그 라이트 모드" />
<img class="dark" src="./assets/airi-docs-blogs-dark.avif" alt="문서 블로그 다크 모드" />
...
<img class="light" src="./assets/airi-packages-i18n-light.avif" alt="packages/i18n 라이트 모드" />
<img class="dark" src="./assets/airi-packages-i18n-dark.avif" alt="packages/i18n 다크 모드" />
...
<div class="w-full flex flex-col items-center justify-center gap-3 py-3">
  <img src="./assets/relu-sticker-thinks.avif" alt="ReLU 스티커 thinks" class="w-30!" />
