...
![](./assets/manual-main-window.avif)
...
![](./assets/manual-controls-island-expanded.avif)
...
![](./assets/manual-consciousness.avif)
...
![](./assets/manual-data-settings.avif)
...
![](./assets/manual-websocket-settings.avif)
...
![](./assets/manual-system-developer.avif)
...
![](./assets/manual-devtools-use-window-mouse.avif)

##### > Displays

여기서 화면상의 마우스 커서 위치를 시각화할 수 있습니다.

![](./assets/manual-devtools-displays.avif)

##### > widgets calling

![](./assets/manual-devtools-widgets-calling.avif)
...
![](./assets/manual-devtools-context-flow.avif)

##### > relative mouse

여기서 이 창 안에서의 마우스 커서 위치를 시각화할 수 있습니다.

![](./assets/manual-devtools-relative-mouse.avif)

##### > beat sync visualizer

![](./assets/manual-devtools-beat-sync.avif)

##### > WebSocket Inspector

![](./assets/manual-devtools-websocket-inspector.avif)

##### > Plugin Host Debug

![](./assets/manual-devtools-plugin-host.avif)
