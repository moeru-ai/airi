...
- [AtomGit](https://atomgit.com/moeru-ai/airi): за размещение AIRI в материковом Китае и помощь местным пользователям с более быстрым доступом к проекту и загрузкам Release.
