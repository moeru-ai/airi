...
- [x] [AIHubMix](https://aihubmix.com/?aff=OOiX) (Prend en charge tous les modèles, optimisation des requêtes de 10 % via ce projet, avec des modèles gratuits disponibles)
