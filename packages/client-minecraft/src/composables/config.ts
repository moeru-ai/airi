...
export function initEnv(): void {
  ...
  config.bot = {
    username: getEnvVar('MINECRAFT_BOT_USERNAME', defaultConfig.bot.username as string),
    host: getEnvVar('MINECRAFT_BOT_HOSTNAME', defaultConfig.bot.host as string),
    port: getEnvNumber('MINECRAFT_BOT_PORT', defaultConfig.bot.port as number),
    password: getEnvVar('MINECRAFT_BOT_PASSWORD', defaultConfig.bot.password as string),
    version: getEnvVar('MINECRAFT_BOT_VERSION', defaultConfig.bot.version as string),
  }
