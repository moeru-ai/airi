//#region src/locales/zh-Hans/settings.yaml
var data = {
	"common": { "save": "保存" },
	"animations": {
		"stage-transitions": { "title": "是否开启舞台动画" },
	...
	"live2d": {
		...
		"theme-color-from-model": {
			"title": "从模型提取主题颜色",
			"button-extract": { "title": "提取" }
		},
		"focus": {
			"title": "禁用模型鼠标跟踪",
			"button-disable": { "title": "禁用" }
		},
		"fps": {
			"title": "帧率",
			"description": "限制渲染帧率",
			"options": { "unlimited": "无限制" }
		}
	},
	"microphone": "麦克风",
	"models": "模型",
	"pages": {
		"card": {
			...
			"character": "角色设定",
			"close": "关闭",
			"chat": { "provider": "聊天 / 提供商" },
			"consciousness": { "model": "意识 / 模型" },
			"created_by": "创建者",
			"creator_notes": "创建者笔记",
			"delete": "删除",
			"delete_card": "删除角色卡",
		...
		"modules": {
			...
			"hearing": {
				"description": "语音识别",
				"title": "听觉",
				"sections": { "section": { "provider-selection": { "description": "选择合适的语音转文本的服务来源" } } }
			},
			"memory-long-term": {
				"description": "长期记忆",
				"title": "长期记忆"
			...
			"messaging-qq": {
				"description": "通过 QQ 对接，支持官方机器人和 NapCat",
				"title": "QQ",
				"enable": "启用 QQ 集成",
				"enable-description": "允许 AIRI 通过 QQ 进行互动",
				"method": "连接方式",
				"method-description": "选择官方机器人 API 或 NapCat WebSocket",
				"methods": {
					"official": "官方 (@sliverp/qqbot)",
					"napcat": "NapCat (OneBot/WebSocket)"
				},
				"official-app-id": "官方机器人 AppID",
				"official-app-id-description": "官方 QQ 机器人鉴权 AppID",
				"official-app-id-placeholder": "输入官方 QQ 机器人 AppID",
				"official-app-secret": "官方机器人 AppSecret",
				"official-app-secret-description": "官方 QQ 机器人鉴权 AppSecret",
				"official-app-secret-placeholder": "输入官方 QQ 机器人 AppSecret",
				"napcat-ws-url": "NapCat WebSocket 地址",
				"napcat-ws-url-description": "NapCat 提供的 WebSocket 接入地址",
				"napcat-ws-url-placeholder": "输入 NapCat WebSocket 地址，例如 ws://127.0.0.1:3001",
				"voice-reply-mode": "回复发送模式",
				"voice-reply-mode-description": "选择回复发送方式；未配置发声模块时会自动回退为仅文本",
				"voice-reply-modes": {
					"both": "语音和文本一起发送",
					"voice": "只发送语音",
					"text": "不发送语音"
				},
				"voice-reply-slow-tip": "注意：如果启用语音发送功能，由于需要生成音频文件，消息发送可能会有延迟，请知悉",
				"voice-reply-fallback-tip": "未检测到发声模块配置，将自动回退为仅文本发送。请先在「语音合成」模块完成服务来源、模型与声线配置。",
				"voice-settings-saving": "保存中...",
				"voice-settings-saved": "语音发送设置已保存",
				"voice-settings-save-failed": "语音发送设置保存失败",
				"voice-generation-status": "语音生成状态：",
				...
				"help-label": "NapCat 文档：",
				"connecting": "QQ 连接中...",
				"connection-error": "QQ 连接失败，请检查配置和日志。",
				"show-logs": "显示实时日志",
				"hide-logs": "隐藏实时日志",
				"clear-logs": "清空日志",
				"runtime-logs": "运行日志",
				"runtime-logs-empty": "暂无运行日志。",
				"pre-chat-tip": "注意事项：1. 首次启动时需要先打开一次设置页面，QQ 网关才会自动连接。2. 程序首次启动时需要先打开一次 AIRI 内置聊天界面，这样 QQ 对话才会有回复。",
				"configured": "QQ 连接成功！"
			},
			"speech": {
				"description": "语音合成",
				"sections": { "section": {
					...
					"voice-settings": {
						"input-ssml": { "placeholder": "请输入 SSML 文本" },
						"use-ssml": {
		...
		"providers": {
			...
			"catalog": { "edit": {
				...
				"config": { "common": { "fields": { "field": {
					...
					"headers": {
						...
						"key": { "placeholder": "请求头名字" },
						"value": { "placeholder": "请求头数值" }
					},
					"thinking-mode": {
						"label": "思考模式",
				...
				"validators": {
					...
					"empty": "没有可用的验证步骤。",
					"openai-compatible": {
						"check-config": { "title": "配置" },
						"check-connectivity": { "title": "连通性" },
						"check-supports-model-listing": { "title": "能够列出模型" },
						"check-supports-chat-completion": { "title": "能够处理 Chat Completion（聊天补全）请求" }
					},
					"status": {
						"validating": "验证中……",
						"valid": "通过",
			...
			"common": {
				...
				"fields": { "field": { "api-key": { "label": "API 密钥" } } },
				"section": {
					"advanced": {
			...
			"provider": {
				...
				"cloudflare-workers-ai": {
					...
					"fields": { "field": {
						...
						"api-key": { "placeholder": "请输入 Cloudflare Workers AI 的 API Key" }
					} },
					"title": "Workers AI"
				},
				"common": {
				...
				"elevenlabs": {
					...
					"playground": {
						...
						"title": "实验平台",
						"validation": { "error-missing-api-key": "需要填写 API Key 才能用哦！" }
					},
				...
				"kokoro-local": {
					...
					"models": {
						"fp32-webgpu": { "description": "基于 WebGPU 的全精度模型 - 建议在支持的设备上使用" },
						"fp32": { "description": "全精度模型" },
						"fp16": { "description": "半精度量化" },
						"q8": { "description": "8-bit 量化" },
						"q4": { "description": "4-bit 量化" },
						"q4f16": { "description": "4-bit 量化 (FP16)" }
					},
					"playground": {
				...
				"transcriptions": { "playground": { "title": "实验平台" } },
				"aihubmix": {
					"title": "AIHubMix",
			...
			"sections": { "section": {
				...
				"developer": {
					...
					"sections": { "section": {
						...
						"context-flow": { "description": "检查传入的上下文更新和传出的聊天流事件" },
						"websocket-inspector": {
							"title": "WebSocket 检查器",
	...
	"sections": { "section": { "general": { "title": "通用" } } },
	"theme": {
		"title": "主题",
	...
	"vrm": {
		...
		"theme-color-from-model": { "button-extract": { "title": "提取" } },
		"skybox": {
