//#region src/locales/en/settings.yaml
var data = {
	"common": { "save": "Save" },
	"animations": {
		"stage-transitions": { "title": "Disable Stage Transitions" },
	...
	"live2d": {
		...
		"edit-motion-map": { "title": "Edit motion map" },
		"map-motions": {
			"play": "Play Motion",
			"title": "Map Motions"
		},
	...
	"pages": {
		"card": {
			...
			"consciousness": { "model": "Consciousness / Model" },
		...
		"modules": {
			"beat_sync": {
				...
				"sections": {
					...
					"beat_visualizer": { "title": "Beat visualizer" },
					"parameters": {
			...
			"consciousness": {
				...
				"sections": { "section": { "provider-model-selection": {
					"collapse": "Collapse",
			...
			"hearing": {
				...
				"title": "Hearing",
				"sections": { "section": { "provider-selection": { "description": "Select the suitable speech recognition provider" } } }
			},
			"memory-long-term": {
			...
			"messaging-qq": {
				"description": "Chat over QQ with official bot API or NapCat",
				"title": "QQ",
				"enable": "Enable QQ Integration",
				"enable-description": "Allow AIRI to interact through QQ",
				"method": "Connection Method",
				"method-description": "Choose official QQ bot API or NapCat websocket",
				"methods": {
					"official": "Official (@sliverp/qqbot)",
					"napcat": "NapCat (OneBot/WebSocket)"
				},
				"official-app-id": "Official Bot AppID",
				"official-app-id-description": "AppID from the official QQ bot platform",
				"official-app-id-placeholder": "Enter your official QQ bot AppID",
				"official-app-secret": "Official Bot AppSecret",
				"official-app-secret-description": "AppSecret from the official QQ bot platform",
				"official-app-secret-placeholder": "Enter your official QQ bot AppSecret",
				"napcat-ws-url": "NapCat WebSocket URL",
				"napcat-ws-url-description": "WebSocket endpoint exposed by NapCat",
				"napcat-ws-url-placeholder": "Enter NapCat WebSocket URL, e.g. ws://127.0.0.1:3001",
				"voice-reply-mode": "Reply Send Mode",
				"voice-reply-mode-description": "Choose how replies are sent. Falls back to text when speech is not configured.",
				"voice-reply-modes": {
					"both": "Send voice + text",
					"voice": "Send voice only",
					"text": "Do not send voice"
				},
				"voice-reply-slow-tip": "Note: if voice sending is enabled, generating audio may delay message delivery.",
				"voice-reply-fallback-tip": "Speech is not configured; voice sending will fall back to text. Configure provider, model and voice in Speech settings.",
				"voice-settings-saving": "Saving...",
				"voice-settings-saved": "Voice sending settings saved",
				"voice-settings-save-failed": "Failed to save voice sending settings",
				"voice-generation-status": "Voice generation status:",
				"voice-generation-status-values": {
					"idle": "Idle",
					"generating": "Generating",
					"success": "Success",
					"failed": "Failed"
				},
				"help-label": "NapCat docs:",
				"connecting": "QQ is connecting...",
				"connection-error": "QQ connection failed. Please check your configuration and logs.",
				"show-logs": "Show real-time logs",
				"hide-logs": "Hide real-time logs",
				"clear-logs": "Clear logs",
				"runtime-logs": "Runtime logs",
				"runtime-logs-empty": "No runtime logs yet.",
				"pre-chat-tip": "Notes: 1. On first launch, open the Settings page once before QQ gateway auto-connect can work. 2. On first launch, open AIRI built-in chat once so QQ conversations can receive replies.",
				"configured": "QQ is connected successfully!"
			},
			"speech": {
				"description": "Speech synthesis",
				"sections": { "section": {
					"playground": {
						"buttons": { "stop": { "label": "Stop" } },
						"select-voice": {
					...
					"voice-settings": {
						"input-ssml": { "placeholder": "Enter SSML text..." },
						"use-ssml": {
		...
		"providers": {
			...
			"helpinfo": {
				...
				"description": "AIRI requires at least one {chat} provider to be configured to think, and behave properly. You could think of it as the brain of the characters living in AIRI system.\n"
			},
			"catalog": { "edit": {
				...
				"validators": {
					...
					"openai-compatible": {
						"check-config": { "title": "Configuration" },
						"check-connectivity": { "title": "Connectivity" },
						"check-supports-model-listing": { "title": "List Models" },
						"check-supports-chat-completion": { "title": "Chat Completion" }
					},
					"status": {
				...
				"providers": { "provider": { "ollama": { "troubleshooting": { "validators": { "openai-compatible-check-connectivity": {
			...
			"common": {
				...
				"fields": { "field": { "api-key": { "label": "API Key Input" } } },
				"section": {
					"advanced": {
						"fields": { "field": { "headers": {
							"description": "Add custom HTTP headers",
							"key": { "placeholder": "Key" },
							"label": "HTTP Headers",
							"value": { "placeholder": "Value" }
			...
			"provider": {
				...
				"cloudflare-workers-ai": {
					...
					"fields": { "field": {
						...
						"api-key": { "placeholder": "Input Cloudflare API Key" }
					} },
				...
				"elevenlabs": {
					...
					"playground": {
						"buttons": { "button": { "test-voice": {
							"generating": "Generating...",
							"label": "Test Voice"
						} } },
						"fields": { "field": {
							"input": { "placeholder": "Enter text to test the voice..." },
							"language": {
						...
						"validation": { "error-missing-api-key": "Please enter an API key to test the voice." }
					},
					"title": "ElevenLabs"
				},
				"kokoro-local": {
					...
					"models": {
						"fp32-webgpu": { "description": "Full precision model using WebGPU - Recommended for supported devices" },
						"fp32": { "description": "Full precision model" },
						"fp16": { "description": "Half precision" },
						"q8": { "description": "8-bit quantized" },
						"q4": { "description": "4-bit quantized" },
						"q4f16": { "description": "4-bit with FP16" }
					},
					"playground": {
				...
				"transcriptions": { "playground": { "title": "Transcription Playground" } },
				"aihubmix": {
					"title": "AIHubMix",
		...
		"system": {
			...
			"sections": { "section": {
				"custom-color": {
					"fields": { "field": { "primary-color": {
						"label": "Primary color",
						"rgb-on": { "title": "I Want It Dynamic!" }
					} } },
					"title": "Color Scheme"
				},
				"developer": {
					...
					"sections": { "section": {
						...
						"context-flow": { "description": "Inspect incoming context updates and outgoing chat stream events" },
						"websocket-inspector": {
		...
		"page": { "developers": { "open-devtools": {
			"title": "Open Developer Tools",
			"button": "Open"
		} } }
	},
	"sections": { "section": { "general": { "title": "General" } } },
	"theme": {
		"title": "Theme",
	...
	"vrm": {
		...
		"theme-color-from-model": { "button-extract": { "title": "Extract" } },
		"skybox": {
	...
	"websocket-secure-enabled": {
		...
		"description": "Enable WSS (WebSocket Secure) to allow HTTPS connections for mobile (pocket) in development mode. This will automatically generate a self-signed certificate."
	},
	"wip": {
