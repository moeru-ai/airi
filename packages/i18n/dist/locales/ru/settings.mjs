//#region src/locales/ru/settings.yaml
var data = {
	"common": { "save": "Сохранить" },
	"animations": {
		"stage-transitions": { "title": "Отключить переходы между сценами" },
	...
	"live2d": {
		...
		"edit-motion-map": { "title": "Редактировать карту движений" },
		"map-motions": {
		...
		"theme-color-from-model": {
			...
			"button-extract": { "title": "Извлечь" }
		},
		"focus": {
			"title": "Отключить слежение за мышью",
			"button-disable": { "title": "Отключить" }
		},
		"fps": {
			"title": "ФПС",
	...
	"pages": {
		"card": {
			...
			"consciousness": { "model": "Сознание / Модель" },
			"created_by": "создано",
		...
		"modules": {
			...
			"speech": {
				...
				"sections": { "section": {
					...
					"voice-settings": {
						"input-ssml": { "placeholder": "Введите SSML-текст..." },
						"use-ssml": {
		...
		"providers": {
			...
			"common": {
				...
				"fields": { "field": { "api-key": { "label": "Ввод API-ключа" } } },
				"section": {
					"advanced": {
			...
			"provider": {
				...
				"cloudflare-workers-ai": {
					...
					"fields": { "field": {
						...
						"api-key": { "placeholder": "Введите Cloudflare API Key" }
					} },
				...
				"elevenlabs": {
					...
					"playground": {
						...
						"fields": { "field": {
							"input": { "placeholder": "Введите текст для теста голоса..." },
							"language": {
						...
						"validation": { "error-missing-api-key": "Введите API-ключ, чтобы протестировать голос." }
					},
					"title": "ElevenLabs"
				},
				"kokoro-local": {
				...
				"transcriptions": { "playground": { "title": "Песочница транскрипции" } },
				"aihubmix": {
					"title": "AIHubMix",
			...
			"sections": { "section": {
				"custom-color": {
					"fields": { "field": { "primary-color": {
						"label": "Основной цвет",
						"rgb-on": { "title": "Хочу динамический!" }
					} } },
					"title": "Цветовая схема"
				},
				"developer": {
	...
	"sections": { "section": { "general": { "title": "Общие" } } },
	"theme": {
		"title": "Тема",
	...
	"vrm": {
		...
		"theme-color-from-model": { "button-extract": { "title": "Извлечь" } },
		"skybox": {
