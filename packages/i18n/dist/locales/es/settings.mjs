//#region src/locales/es/settings.yaml
var data = {
	"common": { "save": "Guardar" },
	"animations": {
		"stage-transitions": { "title": "Desactivar Transiciones del Escenario" },
	...
	"live2d": {
		...
		"edit-motion-map": { "title": "Editar mapa de movimientos" },
		"map-motions": {
	...
	"pages": {
		"card": {
			...
			"character": "Personaje",
			"close": "Cerrar",
			"chat": { "provider": "Chat / Proveedor" },
			"consciousness": { "model": "Consciencia / Modelo" },
		...
		"modules": {
			"beat_sync": {
				...
				"sections": {
					...
					"beat_visualizer": { "title": "Visualizador de ritmos" },
					"parameters": {
			...
			"speech": {
				...
				"sections": { "section": {
					...
					"voice-settings": {
						"input-ssml": { "placeholder": "Ingresa texto SSML..." },
						"use-ssml": {
		...
		"providers": {
			...
			"common": {
				...
				"fields": { "field": { "api-key": { "label": "Entrada de Clave API" } } },
				"section": {
					"advanced": {
					...
					"voice": { "title": "Configuraciones de Voz" }
				}
			},
			...
			"provider": {
				...
				"cloudflare-workers-ai": {
					...
					"fields": { "field": {
						...
						"api-key": { "placeholder": "Ingresa la Clave API de Cloudflare" }
					} },
				...
				"elevenlabs": {
					...
					"playground": {
						...
						"fields": { "field": {
							"input": { "placeholder": "Ingresa texto para probar la voz..." },
							"language": {
						...
						"validation": { "error-missing-api-key": "Por favor ingresa una clave API para probar la voz." }
					},
					"title": "ElevenLabs"
				},
				"kokoro-local": {
					...
					"models": {
						"fp32-webgpu": { "description": "Modelo de precisión completa usando WebGPU - Recomendado para dispositivos compatibles" },
				...
				"transcriptions": { "playground": { "title": "Playground de Transcripción" } },
				"aihubmix": {
					"title": "AIHubMix",
			...
			"sections": { "section": {
				"custom-color": {
					"fields": { "field": { "primary-color": {
						...
						"rgb-on": { "title": "¡Lo Quiero Dinámico!" }
					} } },
					"title": "Esquema de Colores"
				},
				"developer": {
	...
	"vrm": {
		...
		"theme-color-from-model": { "button-extract": { "title": "Extraer" } },
		"skybox": {
