...
const aboutLinks = [
  { label: t('stage.about.links.home'), href: 'https://airi.moeru.ai/docs/', icon: 'i-solar:home-smile-outline' },
  { label: t('stage.about.links.documentations'), href: 'https://airi.moeru.ai/docs/en/docs/overview/', icon: 'i-solar:document-add-outline' },
...
<template>
  <button border="2 solid neutral-100/60 dark:neutral-800/30" bg="neutral-50/70 dark:neutral-800/70" w-fit flex items-center self-end justify-center rounded-xl p-2 backdrop-blur-md :title="t('stage.actions.about')" @click="show = !show">
