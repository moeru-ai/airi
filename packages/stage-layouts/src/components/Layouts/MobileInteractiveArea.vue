    ...
    >
      ...
      >
        <button
          ...
          :class="['size-11 shrink-0 flex items-center justify-center self-end rounded-full', 'bg-neutral-100/80 text-primary-600 backdrop-blur-md dark:bg-neutral-900/80 dark:text-primary-300']"
