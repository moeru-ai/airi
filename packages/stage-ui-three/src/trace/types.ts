...
export type ThreeSceneTraceComponentState = 'loading' | 'mounted' | 'pending'
export type ThreeSceneTraceModelPhase = 'error' | 'loading' | 'no-model' | 'ready'
export type ThreeSceneTracePhase = 'binding' | 'error' | 'loading' | 'mounted' | 'no-model' | 'pending'
