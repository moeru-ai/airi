...
function render(normal: number[], column: number, row = 12, position = [0.5, 0.5]) {
  ...
  `, { uNormal: normal, uPosition: position, u_airiStrength: 1, u_airiChroma: 1, u_airiDirectional: 1, u_airiLights: lights, u_airiStageAspect: 1 })
