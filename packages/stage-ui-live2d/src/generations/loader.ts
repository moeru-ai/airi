...
/** Keeps archive metadata and known VTube Studio sidecars out of model discovery. */
...
/** Recognizes generation-owned settings paths while applying shared ignore rules. */
export function isLive2DSettingsFile(file: string): boolean {
