...
<template>
  <div class="min-h-screen px-4 py-8 md:px-8">
    <div mx-auto max-w-7xl class="space-y-8">
      <section class="bg-linear-to-br relative overflow-hidden rounded-[2rem] from-neutral-950 via-rose-950 to-black px-6 py-8 text-white shadow-sm md:px-10 md:py-12">
      ...
      <template v-else>
        <section class="grid gap-4 lg:grid-cols-[1.3fr,0.7fr]">
          <div class="rounded-[1.75rem] bg-white p-6 shadow-sm ring-1 ring-neutral-200 dark:bg-neutral-900 dark:ring-neutral-800">
            ...
            <div class="grid mt-5 gap-3 sm:grid-cols-4">
              <div class="rounded-2xl bg-neutral-50 px-4 py-3 dark:bg-neutral-800">
                <div class="text-[11px] text-neutral-500 tracking-[0.16em] uppercase dark:text-neutral-400">
                  Total
                </div>
            ...
            <div class="mt-4 space-y-3">
              ...
              >
                <div class="min-w-0">
                  ...
                  <div class="line-clamp-1 mt-1 text-xs opacity-75">
            ...
            <div v-if="selectedCharacter" class="mt-4 space-y-4">
              ...
              <div class="grid gap-4 sm:grid-cols-2">
                <div class="flex flex-col gap-1.5">
                  ...
                  <select v-model="editor.nsfwLevel" class="w-full border border-neutral-200 rounded-lg bg-white px-3 py-2 text-sm outline-none dark:border-neutral-700 dark:bg-neutral-800">
                    <option value="none">
                      None
                    </option>
                ...
                <div class="flex flex-col gap-1.5">
                  ...
                  <select v-model="editor.relationshipMode" class="w-full border border-neutral-200 rounded-lg bg-white px-3 py-2 text-sm outline-none dark:border-neutral-700 dark:bg-neutral-800">
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <select v-model="editor.visibility" class="w-full border border-neutral-200 rounded-lg bg-white px-3 py-2 text-sm outline-none dark:border-neutral-700 dark:bg-neutral-800">
        ...
        <section v-if="featuredCharacter" class="grid gap-4 lg:grid-cols-[1.1fr,0.9fr]">
          <div class="bg-linear-to-br relative overflow-hidden rounded-[2rem] from-neutral-950 via-neutral-900 to-rose-950 p-6 text-white shadow-sm">
            <img
            ...
            >
            <div class="bg-linear-to-r absolute inset-0 from-black via-black/60 to-transparent" />
            <div class="relative z-1 max-w-xl">
              <div class="inline-flex rounded-full bg-white/10 px-3 py-1 text-[11px] font-medium tracking-[0.16em] uppercase backdrop-blur">
                Top By Chats
              </div>
              <h2 class="mt-4 text-3xl font-semibold">
                {{ featuredCharacter.name }}
              </h2>
              <p class="mt-3 text-sm text-white/75 leading-6">
                {{ featuredCharacter.personality || featuredCharacter.scenario || featuredCharacter.tagline }}
              </p>
              <div class="mt-4 flex flex-wrap gap-2">
                <span class="rounded-full bg-white/10 px-3 py-1 text-[11px] font-medium tracking-[0.16em] uppercase backdrop-blur">
          ...
          <div class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-neutral-200 dark:bg-neutral-900 dark:ring-neutral-800">
            ...
            <div class="mt-4 space-y-3">
              <button
                ...
                :key="character.id"
                type="button"
                class="w-full flex items-center justify-between rounded-2xl bg-neutral-50 px-4 py-3 text-left transition dark:bg-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-700"
              ...
              >
                <div class="min-w-0">
                  ...
                  <div class="line-clamp-1 mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                    {{ character.personality || character.tagline }}
                  </div>
                </div>
                <div class="ml-4 flex shrink-0 items-center gap-2">
                  <span class="rounded-full bg-rose-100 px-2 py-0.5 text-[10px] text-rose-700 font-medium tracking-wide uppercase dark:bg-rose-500/15 dark:text-rose-300">
                    {{ character.nsfwLevel }}
                  </span>
        ...
        <section v-else class="grid gap-6 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xl:grid-cols-5">
          <article
            v-for="character in characters"
            :key="character.id"
            ...
            <div class="relative z-7 h-30% overflow-hidden">
              <div class="relative z-1 h-full">
                <div class="relative h-full flex flex-col justify-between gap-2 px-3 pb-3 pt-2">
                  ...
                  <div class="line-clamp-3 max-h-[3rem] flex-1 overflow-hidden text-xs text-neutral-500">
                  ...
                  <div class="grid grid-cols-3 items-center">
                    ...
                    <div class="flex items-center justify-end">
                      <button
                        type="button"
                        class="flex flex-row items-center gap-1 rounded-full bg-neutral-900/65 py-1 pl-1.5 pr-2"
                        @click="openCharacter(character.id)"
                      >
