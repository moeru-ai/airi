      ...
      <div w-full rounded-xl>
        <h2 class="mb-4 text-lg text-neutral-500 md:text-2xl dark:text-neutral-400" w-full>
          <div class="inline-flex items-center gap-4">
            ...
            <div>
              {{ t('settings.pages.modules.speech.sections.section.bilingual-subtitles.title') }}
            </div>
          </div>
        </h2>
        <div flex="~ col gap-4">
          <FieldCheckbox
            ...
            :label="t('settings.pages.modules.speech.sections.section.bilingual-subtitles.enable.label')"
            :description="t('settings.pages.modules.speech.sections.section.bilingual-subtitles.enable.description')"
          />

          <template v-if="bilingualEnabled">
            <div flex="~ col md:row gap-4">
              <div flex="1 ~ col gap-1">
                <label class="text-xs text-neutral-500 font-medium dark:text-neutral-400">{{ t('settings.pages.modules.speech.sections.section.bilingual-subtitles.tts-language') }}</label>
                <select
              ...
              <div flex="1 ~ col gap-1">
                <label class="text-xs text-neutral-500 font-medium dark:text-neutral-400">{{ t('settings.pages.modules.speech.sections.section.bilingual-subtitles.subtitle1') }}</label>
                <select
              ...
              <div flex="1 ~ col gap-1">
                <label class="text-xs text-neutral-500 font-medium dark:text-neutral-400">{{ t('settings.pages.modules.speech.sections.section.bilingual-subtitles.subtitle2') }}</label>
                <select
