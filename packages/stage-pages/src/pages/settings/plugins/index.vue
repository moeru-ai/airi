...
<template>
  <div>
    ...
    >
      <div :class="['text-6xl', 'text-neutral-300', 'i-solar:plug-circle-bold-duotone', 'dark:text-neutral-600']" />
    ...
    <div
      ...
      :class="['flex', 'flex-col', 'items-center', 'justify-center', 'py-12']"
    >
      <div :class="['text-4xl', 'text-primary-500', 'i-svg-spinners:ring-resize']" />
      <p :class="['mt-4', 'text-neutral-500', 'dark:text-neutral-400']">
    ...
    >
      <div :class="['text-4xl', 'text-red-500', 'i-solar:danger-triangle-bold-duotone']" />
