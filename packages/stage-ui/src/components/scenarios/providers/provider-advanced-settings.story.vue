...
<template>
  <Story title="Advanced Settings" group="providers" :layout="{ type: 'grid', width: '100%' }">
    <template #controls>
      <ThemeColorsHueControl />
    </template>

    <Variant id="collapsed" title="Collapsed (Default)">
      <div>
    ...
    <Variant id="expanded" title="Expanded">
      <div>
    ...
    <Variant id="custom-title" title="Custom Title">
      <div>
