  ...
  >
    ...
    >
      <Callout>
        <div>
          ...
          <div>
            The Project Moeka theme, powered by our <a decoration-underline decoration-dashed href="https://github.com/proj-airi/chromatic">Chromatic</a> design system.
          </div>
        </div>
      </Callout>
    </Variant>
    ...
    >
      <Callout theme="violet">
        <div>
          <div>
            Moeka is running pure locally in your browser, and we will never steal your credentials for AI / LLM providers. But keep in mind that your API keys are sensitive information. Make sure to keep them safe and do not share them with anyone.
          </div>
          <div>
            Moeka is open sourced at <div inline-flex translate-y-1 items-center gap-1>
