...
<template>
  <Story title="Cursor Momentum" group="physics" :layout="{ type: 'grid', width: '100%' }">
    <template #controls>
      <ThemeColorsHueControl />
    </template>

    <Variant id="rotating-box" title="Rotating Box">
    ...
    <Variant id="floating-ball" title="Floating Ball">
      <div class="h-40 flex items-center justify-center">
        <CursorMomentum v-slot="{ momentum }" :base-speed="0.5" :friction="0.98" :momentum-factor="0.01">
          <div
    ...
    <Variant id="pulsing-circle" title="Pulsing Circle">
      <div class="h-40 flex items-center justify-center">
        <CursorMomentum v-slot="{ momentum }" :base-speed="1" :friction="0.9" :momentum-factor="0.008">
          <div
    ...
    <Variant id="test-dummy" title="Test Dummy Marker">
      <div class="h-40 flex items-center justify-center">
        <CursorMomentum v-slot="{ currentValue }" :base-speed="0.1" :friction="0.95" :momentum-factor="0.005">
          <div
