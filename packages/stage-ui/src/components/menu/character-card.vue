        ...
        <div h-full flex>
          <div flex="1 ~ col" class="main-container" h-full rounded-l-xl>
            <div flex="1 ~ col" relative>
              <!-- Background section -->
              <div class="background-section-container" flex="~ col 1" relative z-1 overflow-hidden rounded-l-xl>
                <span
              ...
              <div font-jura relative z-3 pb-4 pl-4 pt-2>
                ...
                <div class="title-gradient" absolute bottom-0 left-0 right-0 h-full />
              </div>
              <!-- Cover section -->
          ...
          <!-- Holding section -->
          <div relative z-2 h-full class="bar-container" rounded-r-xl>
...
.card-cover {
  mask-image:
    linear-gradient(11deg, rgba(0, 0, 0, 0) 5%, rgba(0, 0, 0, 1) 13%), radial-gradient(#fff 57%, #ffffff00 86%);
}
