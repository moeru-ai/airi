...
export type EventStartTranscription = BaseEvent<
  'StartTranscription',
  {
...
export type EventStopTranscription = BaseEvent<'StopTranscription', undefined>

export type EventTranscriptionStarted = BaseEvent<
...
export type EventSentenceBegin = BaseEvent<
  'SentenceBegin',
  {
...
export type EventTranscriptionResultChanged = BaseEvent<
...
export type EventSentenceEnd = BaseEvent<
  'SentenceEnd',
  {
    /** Incremental sentence index starting from 1. */
    index: number
...
export type EventTranscriptionCompleted = BaseEvent<'TranscriptionCompleted', undefined>
