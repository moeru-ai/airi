...
export interface EventStartTranscription extends BaseEvent<
  'StartTranscription',
  {
...
export interface EventTranscriptionStarted extends BaseEvent<
...
export interface EventSentenceBegin extends BaseEvent<
  'SentenceBegin',
  {
...
export interface EventTranscriptionResultChanged extends BaseEvent<
...
export interface EventSentenceEnd extends BaseEvent<
  'SentenceEnd',
  {
    /** Incremental sentence index starting from 1. */
    index: number
